...
void	bcm_custom_auth_detach_async(int unit, bcm_custom_auth_params_t * auth_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_auth_init_async(int unit, bcm_custom_auth_params_t * auth_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_auth_mode_get_async(int unit, bcm_custom_auth_params_t * auth_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_auth_mode_set_async(int unit, bcm_custom_auth_params_t * auth_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_auth_params_t_init_async(int unit, bcm_custom_auth_params_t * auth_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_auth_port_get_async(int unit, bcm_gport_t portid, bcm_custom_auth_port_mode_t * port_mode, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_auth_port_mode_t_init_async(int unit, bcm_custom_auth_port_mode_t * auth_port_mode, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_auth_port_set_async(int unit, bcm_gport_t portid, bcm_custom_auth_port_mode_t * port_mode, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_dscp2tc_get_async(int unit, bcm_custom_dscp_t dscp, bcm_custom_tc_t * tc, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_dscp2tc_set_async(int unit, bcm_custom_dscp_t dscp, bcm_custom_tc_t tc, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_flowcontrol_get_async(int unit, bcm_custom_flowcontrol_t * flowcontrol_mode, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_flowcontrol_set_async(int unit, bcm_custom_flowcontrol_t flowcontrol_mode, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_init_async(int unit, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_pfc_flowcontrol_get_async(int unit, int int_pri, bcm_custom_flowcontrol_params_t * fc_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_pfc_flowcontrol_set_async(int unit, int int_pri, bcm_custom_flowcontrol_params_t fc_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_default_pcp_get_async(int unit, bcm_gport_t portid, int * pcp, int * dei, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_default_pcp_set_async(int unit, bcm_gport_t portid, int pcp, int dei, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_default_tc_get_async(int unit, bcm_gport_t portid, bcm_custom_tc_t * tc, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_default_tc_set_async(int unit, bcm_gport_t portid, bcm_custom_tc_t tc, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_flowcontrol_get_async(int unit, bcm_gport_t portid, bcm_custom_flowcontrol_params_t * fc_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_flowcontrol_set_async(int unit, bcm_gport_t portid, bcm_custom_flowcontrol_params_t fc_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_pcp2tc_get_async(int unit, bcm_gport_t portid, int pcp, int dei, bcm_custom_tc_t * tc, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_pcp2tc_set_async(int unit, bcm_gport_t portid, int pcp, int dei, bcm_custom_tc_t tc, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_sched_get_async(int unit, bcm_gport_t portid, bcm_custom_schedule_mode_t * sched_mode, int * weights, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_sched_set_async(int unit, bcm_gport_t portid, bcm_custom_schedule_mode_t sched_mode, int * weights, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_shaper_get_async(int unit, bcm_gport_t portid, bcm_custom_cosq_shaper_params_t * shaper_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_shaper_set_async(int unit, bcm_gport_t portid, bcm_custom_cosq_shaper_params_t * shaper_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_tc2pcp_get_async(int unit, bcm_gport_t portid, bcm_custom_tc_t tc, int * pcp, int * dei, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_port_tc2pcp_set_async(int unit, bcm_gport_t portid, bcm_custom_tc_t tc, int pcp, int dei, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_queue_shaper_get_async(int unit, bcm_gport_t portid, int int_pri, bcm_custom_cosq_shaper_params_t * shaper_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_queue_shaper_set_async(int unit, bcm_gport_t portid, int int_pri, bcm_custom_cosq_shaper_params_t * shaper_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_queue_tsn_get_async(int unit, bcm_gport_t portid, int int_pri, bcm_custom_cosq_tsn_params_t * tsn_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_queue_tsn_set_async(int unit, bcm_gport_t portid, int int_pri, bcm_custom_cosq_tsn_params_t * tsn_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_shaper_params_t_init_async(int unit, bcm_gport_t portid, bcm_custom_cosq_shaper_params_t * shaper_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_tc2dscp_get_async(int unit, bcm_custom_tc_t tc, bcm_custom_dscp_t * dscp, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_tc2dscp_set_async(int unit, bcm_custom_tc_t tc, bcm_custom_dscp_t dscp, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_cosq_tsn_params_t_init_async(int unit, bcm_custom_cosq_tsn_params_t * tsn_params, bcm_async_cb_t async_callback, void *async_cookie);
#ifdef	INCLUDE_PTP
void	bcm_custom_dot1as_debug_bmca_show_async(int unit, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_dot1as_debug_flags_set_async(int unit, uint32 flags, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_dot1as_debug_intf_stats_reset_async(int unit, uint32 intf, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_dot1as_debug_intf_stats_show_async(int unit, uint32 intf, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_dot1as_debug_intf_status_show_async(int unit, uint32 intf, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_dot1as_debug_intl_show_async(int unit, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_dot1as_debug_pdelay_show_async(int unit, uint32 intf, uint8 showlog, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_dot1as_debug_timesync_show_async(int unit, uint8 verbose, uint32 num, bcm_async_cb_t async_callback, void *async_cookie);
#endif	/* INCLUDE_PTP */
void	bcm_custom_field_action_clear_async(int unit, bcm_custom_field_id_t * field_id, uint32 index, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_action_dump_async(int unit, bcm_custom_field_id_t * field_id, uint32 index, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_action_set_async(int unit, bcm_custom_field_id_t * field_id, bcm_custom_field_action_t * action, uint32 index, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_action_t_init_async(int unit, bcm_custom_field_action_t * action, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_detach_async(int unit, bcm_custom_field_id_t field_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_init_async(int unit, bcm_custom_field_params_t * field_params, bcm_custom_field_id_t * field_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_rule_clear_async(int unit, bcm_custom_field_id_t * field_id, uint32 index, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_rule_dump_async(int unit, bcm_custom_field_id_t * field_id, uint32 index, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_rule_set_async(int unit, bcm_custom_field_id_t * field_id, bcm_custom_field_rule_t * rule, uint32 index, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_rule_t_init_async(int unit, bcm_custom_field_l3_l4_pkt_type_t pkt_type, bcm_custom_field_rule_t * rule, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_stat_multi_get_async(int unit, bcm_custom_field_id_t * field_id, uint32 rule_id, int nstat, bcm_field_stat_t * stat_arr, uint64 * value_arr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_stat_multi_get32_async(int unit, bcm_custom_field_id_t * field_id, uint32 rule_id, int nstat, bcm_field_stat_t * stat_arr, uint32 * value_arr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_stat_multi_set_async(int unit, bcm_custom_field_id_t * field_id, uint32 rule_id, int nstat, bcm_field_stat_t * stat_arr, uint64 * value_arr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_field_stat_multi_set32_async(int unit, bcm_custom_field_id_t * field_id, uint32 rule_id, int nstat, bcm_field_stat_t * stat_arr, uint32 * value_arr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_flowcontrol_params_t_init_async(int unit, bcm_gport_t portid, bcm_custom_flowcontrol_params_t * flowcontrol_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_create_async(int unit, bcm_custom_meter_profile_t profile_id, bcm_custom_meter_params_t * meter_params, bcm_custom_meterid_t * meter_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_destroy_async(int unit, bcm_custom_meterid_t meter_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_init_async(int unit, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_params_t_init_async(int unit, bcm_custom_meter_params_t * params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_pm_disable_async(int unit, bcm_custom_meterid_t meter_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_pm_enable_async(int unit, bcm_custom_meterid_t meter_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_pm_get_async(int unit, bcm_custom_meterid_t meter_id, bcm_custom_meter_pm_params_t * pm_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_pm_params_t_init_async(int unit, bcm_custom_meter_pm_params_t * params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_profile_create_async(int unit, bcm_custom_meter_profile_params_t * profile_params, bcm_custom_meter_profile_t * profile_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_profile_destroy_async(int unit, bcm_custom_meter_profile_t profile_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_profile_get_async(int unit, bcm_custom_meter_profile_t profile_id, bcm_custom_meter_profile_params_t * profile_params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_profile_params_t_init_async(int unit, bcm_custom_meter_profile_params_t * params, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_meter_profile_set_async(int unit, bcm_custom_meter_profile_t profile_id, bcm_custom_meter_profile_params_t * profile_params, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_custom_ts_event_config_set_async(int unit, int event_id, int event_source, bcm_custom_ts_event_config_t * config, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_ts_gen_config_set_async(int unit, int generator_id, bcm_custom_ts_gen_config_t * config, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_ts_init_async(int unit, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_ts_tod_get_async(int unit, bcm_custom_ts_time_t * time, uint64 * timestamp, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_custom_ts_tod_set_async(int unit, bcm_custom_ts_time_t time, uint64 timestamp, bcm_async_cb_t async_callback, void *async_cookie);
