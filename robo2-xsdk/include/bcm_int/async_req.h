...
typedef struct bcm_async_req_s {
	...
	union {
		...
		struct {
			int unit;
			bcm_custom_auth_params_t * auth_params;
		} custom_auth_mode_get;
		struct {
			int unit;
			bcm_custom_auth_params_t * auth_params;
		} custom_auth_mode_set;
		struct {
			int unit;
			bcm_custom_auth_params_t * auth_params;
		} custom_auth_params_t_init;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_auth_port_mode_t * port_mode;
		} custom_auth_port_get;
		struct {
			int unit;
			bcm_custom_auth_port_mode_t * auth_port_mode;
		} custom_auth_port_mode_t_init;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_auth_port_mode_t * port_mode;
		} custom_auth_port_set;
		struct {
			int unit;
			bcm_custom_dscp_t dscp;
			bcm_custom_tc_t * tc;
		} custom_cosq_dscp2tc_get;
		struct {
			int unit;
			bcm_custom_dscp_t dscp;
			bcm_custom_tc_t tc;
		} custom_cosq_dscp2tc_set;
		struct {
			int unit;
			bcm_custom_flowcontrol_t * flowcontrol_mode;
		} custom_cosq_flowcontrol_get;
		struct {
			int unit;
			bcm_custom_flowcontrol_t flowcontrol_mode;
		} custom_cosq_flowcontrol_set;
		struct {
			int unit;
		} custom_cosq_init;
		struct {
		...
		} custom_cosq_pfc_flowcontrol_get;
		struct {
			int unit;
			int int_pri;
			bcm_custom_flowcontrol_params_t fc_params;
		} custom_cosq_pfc_flowcontrol_set;
		struct {
			int unit;
			bcm_gport_t portid;
			int * pcp;
			int * dei;
		} custom_cosq_port_default_pcp_get;
		struct {
			int unit;
			bcm_gport_t portid;
			int pcp;
			int dei;
		} custom_cosq_port_default_pcp_set;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_tc_t * tc;
		} custom_cosq_port_default_tc_get;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_tc_t tc;
		} custom_cosq_port_default_tc_set;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_flowcontrol_params_t * fc_params;
		} custom_cosq_port_flowcontrol_get;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_flowcontrol_params_t fc_params;
		} custom_cosq_port_flowcontrol_set;
		struct {
			int unit;
			bcm_gport_t portid;
			int pcp;
		...
		struct {
			...
			int dei;
			bcm_custom_tc_t tc;
		} custom_cosq_port_pcp2tc_set;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_schedule_mode_t * sched_mode;
			int * weights;
		} custom_cosq_port_sched_get;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_schedule_mode_t sched_mode;
			int * weights;
		} custom_cosq_port_sched_set;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_cosq_shaper_params_t * shaper_params;
		} custom_cosq_port_shaper_get;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_cosq_shaper_params_t * shaper_params;
		} custom_cosq_port_shaper_set;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_tc_t tc;
		...
		struct {
			...
			int pcp;
			int dei;
		} custom_cosq_port_tc2pcp_set;
		struct {
			int unit;
			bcm_gport_t portid;
			int int_pri;
			bcm_custom_cosq_shaper_params_t * shaper_params;
		} custom_cosq_queue_shaper_get;
		struct {
			int unit;
			bcm_gport_t portid;
			int int_pri;
			bcm_custom_cosq_shaper_params_t * shaper_params;
		} custom_cosq_queue_shaper_set;
		struct {
			int unit;
			bcm_gport_t portid;
			int int_pri;
			bcm_custom_cosq_tsn_params_t * tsn_params;
		} custom_cosq_queue_tsn_get;
		struct {
			int unit;
			bcm_gport_t portid;
			int int_pri;
			bcm_custom_cosq_tsn_params_t * tsn_params;
		} custom_cosq_queue_tsn_set;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_cosq_shaper_params_t * shaper_params;
		} custom_cosq_shaper_params_t_init;
		struct {
			int unit;
			bcm_custom_tc_t tc;
			bcm_custom_dscp_t * dscp;
		} custom_cosq_tc2dscp_get;
		struct {
			int unit;
			bcm_custom_tc_t tc;
			bcm_custom_dscp_t dscp;
		} custom_cosq_tc2dscp_set;
		struct {
			int unit;
			bcm_custom_cosq_tsn_params_t * tsn_params;
		} custom_cosq_tsn_params_t_init;
#ifdef	INCLUDE_PTP
		struct {
			int unit;
		} custom_dot1as_debug_bmca_show;
		struct {
			int unit;
			uint32 flags;
		} custom_dot1as_debug_flags_set;
		struct {
			int unit;
			uint32 intf;
		} custom_dot1as_debug_intf_stats_reset;
		struct {
			int unit;
			uint32 intf;
		} custom_dot1as_debug_intf_stats_show;
		struct {
			int unit;
			uint32 intf;
		} custom_dot1as_debug_intf_status_show;
		struct {
			int unit;
		} custom_dot1as_debug_intl_show;
		struct {
			int unit;
			uint32 intf;
			uint8 showlog;
		} custom_dot1as_debug_pdelay_show;
		struct {
			int unit;
			uint8 verbose;
			uint32 num;
		} custom_dot1as_debug_timesync_show;
#endif	/* INCLUDE_PTP */
		struct {
			int unit;
			bcm_custom_field_id_t * field_id;
			uint32 index;
		} custom_field_action_clear;
		struct {
			int unit;
			bcm_custom_field_id_t * field_id;
			uint32 index;
		} custom_field_action_dump;
		struct {
			int unit;
			bcm_custom_field_id_t * field_id;
			bcm_custom_field_action_t * action;
			uint32 index;
		} custom_field_action_set;
		struct {
			int unit;
			bcm_custom_field_action_t * action;
		} custom_field_action_t_init;
		struct {
			int unit;
			bcm_custom_field_id_t field_id;
		} custom_field_detach;
		...
		struct {
			...
			bcm_custom_field_id_t * field_id;
			uint32 index;
		} custom_field_rule_clear;
		struct {
			int unit;
			bcm_custom_field_id_t * field_id;
			uint32 index;
		} custom_field_rule_dump;
		struct {
			int unit;
			bcm_custom_field_id_t * field_id;
			bcm_custom_field_rule_t * rule;
			uint32 index;
		} custom_field_rule_set;
		struct {
			int unit;
			bcm_custom_field_l3_l4_pkt_type_t pkt_type;
			bcm_custom_field_rule_t * rule;
		} custom_field_rule_t_init;
		struct {
			int unit;
			bcm_custom_field_id_t * field_id;
			uint32 rule_id;
		...
		struct {
			...
			bcm_field_stat_t * stat_arr;
			uint32 * value_arr;
		} custom_field_stat_multi_set32;
		struct {
			int unit;
			bcm_gport_t portid;
			bcm_custom_flowcontrol_params_t * flowcontrol_params;
		} custom_flowcontrol_params_t_init;
		struct {
			int unit;
		...
		} custom_meter_params_t_init;
		struct {
			int unit;
			bcm_custom_meterid_t meter_id;
		} custom_meter_pm_disable;
		struct {
			int unit;
			bcm_custom_meterid_t meter_id;
		} custom_meter_pm_enable;
		struct {
			int unit;
			bcm_custom_meterid_t meter_id;
		...
		struct {
			int unit;
			bcm_custom_meter_profile_t profile_id;
		} custom_meter_profile_destroy;
		struct {
			int unit;
			bcm_custom_meter_profile_t profile_id;
			bcm_custom_meter_profile_params_t * profile_params;
		} custom_meter_profile_get;
		struct {
			int unit;
			bcm_custom_meter_profile_params_t * params;
		} custom_meter_profile_params_t_init;
		struct {
			int unit;
			bcm_custom_meter_profile_t profile_id;
			bcm_custom_meter_profile_params_t * profile_params;
		} custom_meter_profile_set;
		struct {
			int unit;
			bcm_port_t port;
			int type;
		...
		} custom_ts_event_config_set;
		struct {
			int unit;
			int generator_id;
			bcm_custom_ts_gen_config_t * config;
		} custom_ts_gen_config_set;
		struct {
			int unit;
		} custom_ts_init;
		struct {
...
typedef enum {
	...
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_DETACH,
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_MODE_GET,
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_MODE_SET,
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_PARAMS_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_PORT_GET,
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_PORT_MODE_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_AUTH_PORT_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_DSCP2TC_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_DSCP2TC_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_FLOWCONTROL_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_FLOWCONTROL_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PFC_FLOWCONTROL_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PFC_FLOWCONTROL_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_DEFAULT_PCP_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_DEFAULT_PCP_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_DEFAULT_TC_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_DEFAULT_TC_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_FLOWCONTROL_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_FLOWCONTROL_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_PCP2TC_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_PCP2TC_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_SCHED_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_SCHED_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_SHAPER_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_SHAPER_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_TC2PCP_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_PORT_TC2PCP_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_QUEUE_SHAPER_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_QUEUE_SHAPER_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_QUEUE_TSN_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_QUEUE_TSN_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_SHAPER_PARAMS_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_TC2DSCP_GET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_TC2DSCP_SET,
	BCM_ASYNC_ENTRY_CUSTOM_COSQ_TSN_PARAMS_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_BMCA_SHOW,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_FLAGS_SET,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_INTF_STATS_RESET,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_INTF_STATS_SHOW,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_INTF_STATUS_SHOW,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_INTL_SHOW,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_PDELAY_SHOW,
	BCM_ASYNC_ENTRY_CUSTOM_DOT1AS_DEBUG_TIMESYNC_SHOW,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_ACTION_CLEAR,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_ACTION_DUMP,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_ACTION_SET,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_ACTION_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_DETACH,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_RULE_CLEAR,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_RULE_DUMP,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_RULE_SET,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_RULE_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_STAT_MULTI_GET,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_STAT_MULTI_GET32,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_STAT_MULTI_SET,
	BCM_ASYNC_ENTRY_CUSTOM_FIELD_STAT_MULTI_SET32,
	BCM_ASYNC_ENTRY_CUSTOM_FLOWCONTROL_PARAMS_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_METER_CREATE,
	BCM_ASYNC_ENTRY_CUSTOM_METER_DESTROY,
	BCM_ASYNC_ENTRY_CUSTOM_METER_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PARAMS_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PM_DISABLE,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PM_ENABLE,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PM_GET,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PM_PARAMS_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PROFILE_CREATE,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PROFILE_DESTROY,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PROFILE_GET,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PROFILE_PARAMS_T_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_METER_PROFILE_SET,
	BCM_ASYNC_ENTRY_CUSTOM_PORT_GET,
	BCM_ASYNC_ENTRY_CUSTOM_PORT_SET,
	BCM_ASYNC_ENTRY_CUSTOM_REGISTER,
	BCM_ASYNC_ENTRY_CUSTOM_TS_EVENT_CONFIG_SET,
	BCM_ASYNC_ENTRY_CUSTOM_TS_GEN_CONFIG_SET,
	BCM_ASYNC_ENTRY_CUSTOM_TS_INIT,
	BCM_ASYNC_ENTRY_CUSTOM_TS_TOD_GET,
	BCM_ASYNC_ENTRY_CUSTOM_TS_TOD_SET,
