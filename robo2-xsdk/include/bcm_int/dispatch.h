...
typedef struct {
	...
	int (*custom_auth_detach)(int,bcm_custom_auth_params_t *);
	int (*custom_auth_init)(int,bcm_custom_auth_params_t *);
	int (*custom_auth_mode_get)(int,bcm_custom_auth_params_t *);
	int (*custom_auth_mode_set)(int,bcm_custom_auth_params_t *);
	int (*custom_auth_params_t_init)(int,bcm_custom_auth_params_t *);
	int (*custom_auth_port_get)(int,bcm_gport_t,bcm_custom_auth_port_mode_t *);
	int (*custom_auth_port_mode_t_init)(int,bcm_custom_auth_port_mode_t *);
	int (*custom_auth_port_set)(int,bcm_gport_t,bcm_custom_auth_port_mode_t *);
	int (*custom_cosq_dscp2tc_get)(int,bcm_custom_dscp_t,bcm_custom_tc_t *);
	int (*custom_cosq_dscp2tc_set)(int,bcm_custom_dscp_t,bcm_custom_tc_t);
	int (*custom_cosq_flowcontrol_get)(int,bcm_custom_flowcontrol_t *);
	int (*custom_cosq_flowcontrol_set)(int,bcm_custom_flowcontrol_t);
	int (*custom_cosq_init)(int);
	int (*custom_cosq_pfc_flowcontrol_get)(int,int,bcm_custom_flowcontrol_params_t *);
	int (*custom_cosq_pfc_flowcontrol_set)(int,int,bcm_custom_flowcontrol_params_t);
	int (*custom_cosq_port_default_pcp_get)(int,bcm_gport_t,int *,int *);
	int (*custom_cosq_port_default_pcp_set)(int,bcm_gport_t,int,int);
	int (*custom_cosq_port_default_tc_get)(int,bcm_gport_t,bcm_custom_tc_t *);
	int (*custom_cosq_port_default_tc_set)(int,bcm_gport_t,bcm_custom_tc_t);
	int (*custom_cosq_port_flowcontrol_get)(int,bcm_gport_t,bcm_custom_flowcontrol_params_t *);
	int (*custom_cosq_port_flowcontrol_set)(int,bcm_gport_t,bcm_custom_flowcontrol_params_t);
	int (*custom_cosq_port_pcp2tc_get)(int,bcm_gport_t,int,int,bcm_custom_tc_t *);
	int (*custom_cosq_port_pcp2tc_set)(int,bcm_gport_t,int,int,bcm_custom_tc_t);
	int (*custom_cosq_port_sched_get)(int,bcm_gport_t,bcm_custom_schedule_mode_t *,int *);
	int (*custom_cosq_port_sched_set)(int,bcm_gport_t,bcm_custom_schedule_mode_t,int *);
	int (*custom_cosq_port_shaper_get)(int,bcm_gport_t,bcm_custom_cosq_shaper_params_t *);
	int (*custom_cosq_port_shaper_set)(int,bcm_gport_t,bcm_custom_cosq_shaper_params_t *);
	int (*custom_cosq_port_tc2pcp_get)(int,bcm_gport_t,bcm_custom_tc_t,int *,int *);
	int (*custom_cosq_port_tc2pcp_set)(int,bcm_gport_t,bcm_custom_tc_t,int,int);
	int (*custom_cosq_queue_shaper_get)(int,bcm_gport_t,int,bcm_custom_cosq_shaper_params_t *);
	int (*custom_cosq_queue_shaper_set)(int,bcm_gport_t,int,bcm_custom_cosq_shaper_params_t *);
	int (*custom_cosq_queue_tsn_get)(int,bcm_gport_t,int,bcm_custom_cosq_tsn_params_t *);
	int (*custom_cosq_queue_tsn_set)(int,bcm_gport_t,int,bcm_custom_cosq_tsn_params_t *);
	int (*custom_cosq_shaper_params_t_init)(int,bcm_gport_t,bcm_custom_cosq_shaper_params_t *);
	int (*custom_cosq_tc2dscp_get)(int,bcm_custom_tc_t,bcm_custom_dscp_t *);
	int (*custom_cosq_tc2dscp_set)(int,bcm_custom_tc_t,bcm_custom_dscp_t);
	int (*custom_cosq_tsn_params_t_init)(int,bcm_custom_cosq_tsn_params_t *);
#ifdef	INCLUDE_PTP
	int (*custom_dot1as_debug_bmca_show)(int);
	int (*custom_dot1as_debug_flags_set)(int,uint32);
	int (*custom_dot1as_debug_intf_stats_reset)(int,uint32);
	int (*custom_dot1as_debug_intf_stats_show)(int,uint32);
	int (*custom_dot1as_debug_intf_status_show)(int,uint32);
	int (*custom_dot1as_debug_intl_show)(int);
	int (*custom_dot1as_debug_pdelay_show)(int,uint32,uint8);
	int (*custom_dot1as_debug_timesync_show)(int,uint8,uint32);
#endif	/* INCLUDE_PTP */
	int (*custom_field_action_clear)(int,bcm_custom_field_id_t *,uint32);
	int (*custom_field_action_dump)(int,bcm_custom_field_id_t *,uint32);
	int (*custom_field_action_set)(int,bcm_custom_field_id_t *,bcm_custom_field_action_t *,uint32);
	int (*custom_field_action_t_init)(int,bcm_custom_field_action_t *);
	int (*custom_field_detach)(int,bcm_custom_field_id_t);
	int (*custom_field_init)(int,bcm_custom_field_params_t *,bcm_custom_field_id_t *);
	int (*custom_field_rule_clear)(int,bcm_custom_field_id_t *,uint32);
	int (*custom_field_rule_dump)(int,bcm_custom_field_id_t *,uint32);
	int (*custom_field_rule_set)(int,bcm_custom_field_id_t *,bcm_custom_field_rule_t *,uint32);
	int (*custom_field_rule_t_init)(int,bcm_custom_field_l3_l4_pkt_type_t,bcm_custom_field_rule_t *);
	int (*custom_field_stat_multi_get)(int,bcm_custom_field_id_t *,uint32,int,bcm_field_stat_t *,uint64 *);
	int (*custom_field_stat_multi_get32)(int,bcm_custom_field_id_t *,uint32,int,bcm_field_stat_t *,uint32 *);
	int (*custom_field_stat_multi_set)(int,bcm_custom_field_id_t *,uint32,int,bcm_field_stat_t *,uint64 *);
	int (*custom_field_stat_multi_set32)(int,bcm_custom_field_id_t *,uint32,int,bcm_field_stat_t *,uint32 *);
	int (*custom_flowcontrol_params_t_init)(int,bcm_gport_t,bcm_custom_flowcontrol_params_t *);
	int (*custom_meter_create)(int,bcm_custom_meter_profile_t,bcm_custom_meter_params_t *,bcm_custom_meterid_t *);
	int (*custom_meter_destroy)(int,bcm_custom_meterid_t);
	int (*custom_meter_init)(int);
	int (*custom_meter_params_t_init)(int,bcm_custom_meter_params_t *);
	int (*custom_meter_pm_disable)(int,bcm_custom_meterid_t);
	int (*custom_meter_pm_enable)(int,bcm_custom_meterid_t);
	int (*custom_meter_pm_get)(int,bcm_custom_meterid_t,bcm_custom_meter_pm_params_t *);
	int (*custom_meter_pm_params_t_init)(int,bcm_custom_meter_pm_params_t *);
	int (*custom_meter_profile_create)(int,bcm_custom_meter_profile_params_t *,bcm_custom_meter_profile_t *);
	int (*custom_meter_profile_destroy)(int,bcm_custom_meter_profile_t);
	int (*custom_meter_profile_get)(int,bcm_custom_meter_profile_t,bcm_custom_meter_profile_params_t *);
	int (*custom_meter_profile_params_t_init)(int,bcm_custom_meter_profile_params_t *);
	int (*custom_meter_profile_set)(int,bcm_custom_meter_profile_t,bcm_custom_meter_profile_params_t *);
	...
	int (*custom_ts_event_config_set)(int,int,int,bcm_custom_ts_event_config_t *);
	int (*custom_ts_gen_config_set)(int,int,bcm_custom_ts_gen_config_t *);
	int (*custom_ts_init)(int);
	int (*custom_ts_tod_get)(int,bcm_custom_ts_time_t *,uint64 *);
	int (*custom_ts_tod_set)(int,bcm_custom_ts_time_t,uint64);
