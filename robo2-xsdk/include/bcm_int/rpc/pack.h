...
#define	BCM_PACKLEN_CUSTOM_AUTH_PARAMS		20
#define	BCM_PACKLEN_CUSTOM_COSQ_SHAPER_PARAMS		20
#define	BCM_PACKLEN_CUSTOM_COSQ_TSN_PARAMS		36
#define	BCM_PACKLEN_CUSTOM_DSCP		8
#define	BCM_PACKLEN_CUSTOM_FIELD_ACTION		756
#define	BCM_PACKLEN_CUSTOM_FIELD_RULE		15
#define	BCM_PACKLEN_CUSTOM_FLOWCONTROL_PARAMS		24
#define	BCM_PACKLEN_CUSTOM_METER_PARAMS		20
#define	BCM_PACKLEN_CUSTOM_METER_PM_PARAMS		208
#define	BCM_PACKLEN_CUSTOM_METER_PROFILE_PARAMS		28
#define	BCM_PACKLEN_CUSTOM_TC		8
#define	BCM_PACKLEN_CUSTOM_TS_GEN_CONFIG		24
#define	BCM_PACKLEN_CUSTOM_TS_TIME		12
#ifdef	INCLUDE_L3
...
extern uint8 *_bcm_pack_custom_auth_params(uint8 *, bcm_custom_auth_params_t *);
extern uint8 *_bcm_unpack_custom_auth_params(uint8 *, bcm_custom_auth_params_t *);
extern uint8 *_bcm_pack_custom_cosq_shaper_params(uint8 *, bcm_custom_cosq_shaper_params_t *);
extern uint8 *_bcm_unpack_custom_cosq_shaper_params(uint8 *, bcm_custom_cosq_shaper_params_t *);
extern uint8 *_bcm_pack_custom_cosq_tsn_params(uint8 *, bcm_custom_cosq_tsn_params_t *);
extern uint8 *_bcm_unpack_custom_cosq_tsn_params(uint8 *, bcm_custom_cosq_tsn_params_t *);
extern uint8 *_bcm_pack_custom_dscp(uint8 *, bcm_custom_dscp_t *);
extern uint8 *_bcm_unpack_custom_dscp(uint8 *, bcm_custom_dscp_t *);
extern uint8 *_bcm_pack_custom_field_action(uint8 *, bcm_custom_field_action_t *);
extern uint8 *_bcm_unpack_custom_field_action(uint8 *, bcm_custom_field_action_t *);
extern uint8 *_bcm_pack_custom_field_rule(uint8 *, bcm_custom_field_rule_t *);
extern uint8 *_bcm_unpack_custom_field_rule(uint8 *, bcm_custom_field_rule_t *);
extern uint8 *_bcm_pack_custom_flowcontrol_params(uint8 *, bcm_custom_flowcontrol_params_t *);
extern uint8 *_bcm_unpack_custom_flowcontrol_params(uint8 *, bcm_custom_flowcontrol_params_t *);
extern uint8 *_bcm_pack_custom_meter_params(uint8 *, bcm_custom_meter_params_t *);
extern uint8 *_bcm_unpack_custom_meter_params(uint8 *, bcm_custom_meter_params_t *);
extern uint8 *_bcm_pack_custom_meter_pm_params(uint8 *, bcm_custom_meter_pm_params_t *);
extern uint8 *_bcm_unpack_custom_meter_pm_params(uint8 *, bcm_custom_meter_pm_params_t *);
extern uint8 *_bcm_pack_custom_meter_profile_params(uint8 *, bcm_custom_meter_profile_params_t *);
extern uint8 *_bcm_unpack_custom_meter_profile_params(uint8 *, bcm_custom_meter_profile_params_t *);
extern uint8 *_bcm_pack_custom_tc(uint8 *, bcm_custom_tc_t *);
extern uint8 *_bcm_unpack_custom_tc(uint8 *, bcm_custom_tc_t *);
extern uint8 *_bcm_pack_custom_ts_gen_config(uint8 *, bcm_custom_ts_gen_config_t *);
extern uint8 *_bcm_unpack_custom_ts_gen_config(uint8 *, bcm_custom_ts_gen_config_t *);
extern uint8 *_bcm_pack_custom_ts_time(uint8 *, bcm_custom_ts_time_t *);
extern uint8 *_bcm_unpack_custom_ts_time(uint8 *, bcm_custom_ts_time_t *);
#ifdef	INCLUDE_L3
