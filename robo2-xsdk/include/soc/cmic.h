...
extern int soc_robo_miim_int_write(int unit, uint32 phy_id,
                              uint32 phy_reg_addr, uint16 phy_wr_data);
extern int soc_robo2_miim_int_write(int unit, uint32 phy_id,
                              uint32 phy_reg_addr, uint16 phy_wr_data);
...
extern int soc_robo_miim_int_read(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 *phy_rd_data);
extern int soc_robo2_miim_int_read(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 *phy_rd_data);
extern int soc_robo2_pmi_int_read(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 *phy_rd_data);
extern int soc_robo2_pmi_int_write(int unit, uint32 phy_id,
                             uint32 phy_reg_addr, uint16 phy_rd_data);
