...
/* Reset value for snake test - hexadecimal value */
#define spn_FE_SNAKE_TEST_RESET  "fe_snake_test_reset"
#endif

#ifdef VENDOR_BROADCOM
/* Reset value for snake test */
#define spn_FE_SNAKE_TEST_RESET_LO  "fe_snake_test_reset_lo"
#endif

#ifdef VENDOR_BROADCOM
/* Reset value for snake test */
#define spn_FE_SNAKE_TEST_RESET_HI  "fe_snake_test_reset_hi"
#endif
...
/* VSC128 cell multicast ID mapping  */
#define spn_FE_VSC128_MC_BASE_ID  "fe_vsc128_mc_base_id"
#endif
...
#ifdef VENDOR_CUSTOMER52
/* Connect User interrupt handler as interrupt CallBack. */
#define spn_USER_INTERRUPT_MODE  "user_interrupt_mode"
#endif
...
#ifdef VENDOR_CUSTOMER52/*
 * Enable CL scheduler out of band flow-control interface.
 * 0: disable
 * 1: enable
 */
#define spn_ENABLE_CL_SCHEDULER_OOB_FC  "enable_cl_scheduler_oob_fc"
#endif

#ifdef VENDOR_CUSTOMER52/*
 * Set calendar length of CL scheduler out of band flow-control interface.
 * Range: 0-4095
 */
#define spn_SCHEDULER_CL_OOB_CALENDAR_LENGTH  "scheduler_cl_oob_calendar_length"
#endif
/*
...
#ifdef VENDOR_CUSTOMER52/*
 * Scheduler OOB WatchDog Period (Cisco Only).
 * Cisco can use a separate OOB interface to control the Arad Credit Scheduler directly.
 * A watchdog enables them to know when the Flow control indications are corrupted.
 * When no good message was received during the last configured period, an error indication is raised. A value of 0 disables the WatchDog.
 */
#define spn_SCHEDULER_CL_OOB_WATCHDOG_PERIOD  "scheduler_cl_oob_watchdog_period"
#endif
/*
...
#ifdef VENDOR_BROADCOM
/* Enable the PortMod library */
#define spn_PORTMOD_ENABLE  "portmod_enable"
#endif
...
{ \
  ...
  "enable_cl_scheduler_oob_fc",  	/* VENDOR_CUSTOMER52 */\
  ...
  "fe_snake_test_reset",  	/* VENDOR_BROADCOM */\
  "fe_snake_test_reset_hi",  	/* VENDOR_BROADCOM */\
  "fe_snake_test_reset_lo",  	/* VENDOR_BROADCOM */\
  "fe_vsc128_mc_base_id",  	/* VENDOR_CUSTOMER52 */\
  "field_atomic_update", \
  "field_class_id_size", \
  ...
  "portgroup", \
  "portmap", \
  "portmod_enable",  	/* VENDOR_BROADCOM */\
  "portmon_interval", \
  "portmon_thread_pri", \
  "post_headers_size", \
  "post_init_enable", \
  ...
  "schan_intr_enable", \
  "schan_timeout_usec", \
  "scheduler_cl_oob_calendar_length",  	/* VENDOR_CUSTOMER52 */\
  "scheduler_cl_oob_watchdog_period",  	/* VENDOR_CUSTOMER52 */\
  ...
  "user_buffer_size", \
  "user_delay", \
  "user_interrupt_mode",  	/* VENDOR_CUSTOMER52 */\
  "v4mc_str_sel", \
  "v4uc_str_sel", \
