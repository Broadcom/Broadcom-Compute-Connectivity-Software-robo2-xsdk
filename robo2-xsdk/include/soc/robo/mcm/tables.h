...
#ifndef _SOC_ROBO_TABLES_H
#define _SOC_ROBO_TABLES_H
...
#define SOC_REG_FIELD_SET(u, r, rv, f, fv) \
    DRV_REG_FIELD_SET(u, r, rv, f##_ROBO, fv)
/**
...
#define SOC_REG_FIELD_GET(u, r, rv, f, fv) \
    DRV_REG_FIELD_GET(u, r, rv, f##_ROBO, fv)

/*
 * Flags to control Table Dump Output formats
 */
#define SOC_ROBO_TABLE_FORMAT_DEC 0
#define SOC_ROBO_TABLE_FORMAT_HEX 1
#define SOC_ROBO_TABLE_FORMAT_NZ  2
