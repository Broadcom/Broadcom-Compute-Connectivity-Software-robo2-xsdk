...
static inline
int64 ts_time_diff(cbx_ts_time_t s1, cbx_ts_time_t s2){
...
typedef struct ts_nco_config_s {
    uint32_t flags;
    int32 nominal_frequency; /* Should be set to 250Mhz */
    int32 freq_offset; /* positive or negative parts-per-billion */
    int32 phase_offset; /* one-time phase offset in nanoseconds */
} ts_nco_config_t;
