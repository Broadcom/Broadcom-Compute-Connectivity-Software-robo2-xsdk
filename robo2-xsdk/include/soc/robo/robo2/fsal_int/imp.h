...
#define CBXI_BRCM_UNPACK_SPP(w, h)   ((h)->sport = ((w >> CBXI_BRCM_EGR_SPORT_POS) & CBXI_BRCM_EGR_SPORT_MSK))
#define CBXI_BRCM_UNPACK_TC(w, h)   ((h)->tc = ((w >> CBXI_BRCM_EGR_TC_POS) & CBXI_BRCM_EGR_TC_MSK))
#define CBXI_BRCM_UNPACK_FWDOP(w, h) ((h)->fwdop = ((w >> CBXI_BRCM_EGR_FWDOP_POS) & CBXI_BRCM_EGR_FWDOP_MSK))
#define CBXI_BRCM_UNPACK_EXCEP(w, h)  ((h)->exception = ((w >> CBXI_BRCM_EGR_EXCEPTION_POS) & CBXI_BRCM_EGR_EXCEPTION_MSK))
#define CBXI_BRCM_UNPACK_OPCODE(w, h)  ((h)->opcode = ((w >> CBXI_BRCM_EGR_OPCODE_POS) & CBXI_BRCM_EGR_OPCODE_MSK))

#define CBXI_BRCM_UNPACK_W0(w0, cbh)                                         \
           CBXI_BRCM_UNPACK_SPP(w0, cbh); CBXI_BRCM_UNPACK_TC(w0, cbh); \
           CBXI_BRCM_UNPACK_FWDOP(w0, cbh);     \
           CBXI_BRCM_UNPACK_EXCEP(w0, cbh); CBXI_BRCM_UNPACK_OPCODE(w0, cbh)
