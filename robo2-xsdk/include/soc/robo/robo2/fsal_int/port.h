...
#define CBX_PORT_MAX_GPHY_PORTS 8  /* Total GPHY ports */
...
#define CBX_PORT_ECPU       ((PBMP_ALL(0) & (1 << 0)) ? 0 : 8)  /* External CPU Port, Non RGMII */
#endif
...
#define CBX_PORT_RGMII      14  /* External CPU Port, RGMII */
