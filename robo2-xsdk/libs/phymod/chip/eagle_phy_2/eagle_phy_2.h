...
#ifndef _EAGLE_PHY_2_H__H_
#define _EAGLE_PHY_2_H__H_
...
int eagle_phy_2_phy_interface_config_get(const phymod_phy_access_t* phy, uint32_t flags, phymod_ref_clk_t ref_clock, phymod_phy_inf_config_t* config);
...
int eagle_phy_2_phy_autoneg_get(const phymod_phy_access_t* phy, phymod_autoneg_control_t* an, uint32_t* an_done);
...
int eagle_phy_2_phy_rx_pmd_locked_get(const phymod_phy_access_t* phy, uint32_t* rx_pmd_locked);
