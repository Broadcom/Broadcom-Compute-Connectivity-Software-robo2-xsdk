...
#include "eagle_phy_2.h"
#include "eagle_phy_2_common.h"


__phymod__dispatch__t__ phymod_eagle_phy_2_driver = {

    eagle_phy_2_core_identify,
    eagle_phy_2_core_info_get,
    eagle_phy_2_core_lane_map_set,
    eagle_phy_2_core_lane_map_get,
    eagle_phy_2_core_reset_set,
    eagle_phy_2_core_reset_get,
    eagle_phy_2_core_firmware_info_get,
    ...
    eagle_phy_2_core_pll_sequencer_restart,
    eagle_phy_2_core_wait_event,
    eagle_phy_2_phy_rx_restart,
    eagle_phy_2_phy_polarity_set,
    eagle_phy_2_phy_polarity_get,
    eagle_phy_2_phy_tx_set,
    eagle_phy_2_phy_tx_get,
    eagle_phy_2_phy_media_type_tx_get,
    eagle_phy_2_phy_tx_override_set,
    eagle_phy_2_phy_tx_override_get,
    eagle_phy_2_phy_rx_set,
    eagle_phy_2_phy_rx_get,
    NULL, /* phymod_phy_rx_adaptation_resume */
    eagle_phy_2_phy_reset_set,
    eagle_phy_2_phy_reset_get,
    eagle_phy_2_phy_power_set,
    eagle_phy_2_phy_power_get,
    NULL, /* phymod_phy_hg2_codec_control_set */
    NULL, /* phymod_phy_hg2_codec_control_get */
    eagle_phy_2_phy_tx_lane_control_set,
    eagle_phy_2_phy_tx_lane_control_get,
    eagle_phy_2_phy_rx_lane_control_set,
    eagle_phy_2_phy_rx_lane_control_get,
    ...
    eagle_phy_2_phy_interface_config_set,
    eagle_phy_2_phy_interface_config_get,
    eagle_phy_2_phy_cl72_set,
    eagle_phy_2_phy_cl72_get,
    eagle_phy_2_phy_cl72_status_get,
    eagle_phy_2_phy_autoneg_ability_set,
    eagle_phy_2_phy_autoneg_ability_get,
    NULL, /* phymod_phy_autoneg_remote_ability_get */
    eagle_phy_2_phy_autoneg_set,
    eagle_phy_2_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    eagle_phy_2_phy_autoneg_status_get,
    eagle_phy_2_core_init,
    NULL, /* phymod_phy_pll_multiplier_get */
    eagle_phy_2_phy_init,
    eagle_phy_2_phy_loopback_set,
    eagle_phy_2_phy_loopback_get,
    eagle_phy_2_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_signal_detect_get */
    eagle_phy_2_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    NULL, /* phymod_phy_pcs_userspeed_set */
    NULL, /* phymod_phy_pcs_userspeed_get */
    eagle_phy_2_phy_reg_read,
    eagle_phy_2_phy_reg_write,
