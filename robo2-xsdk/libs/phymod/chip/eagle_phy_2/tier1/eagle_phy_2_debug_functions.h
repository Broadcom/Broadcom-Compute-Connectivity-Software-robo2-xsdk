 ...
 *****************************************************************************************
 *                                                                                       *
 *  Revision      :  $Id: eagle_phy_2_debug_functions.h 316 2014-02-18 01:31:43Z kirand $ *
 *                                                                                       *
...
/** @file eagle_phy_2_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef EAGLE_PHY_2_DEBUG_FUNCTIONS_H
#define EAGLE_PHY_2_DEBUG_FUNCTIONS_H
...
struct eagle_phy_2_usr_ctrl_func_st {
...
struct eagle_phy_2_usr_ctrl_dfe_func_st {
...
struct eagle_phy_2_usr_ctrl_disable_functions_st {
  struct eagle_phy_2_usr_ctrl_func_st field;
  uint8_t  byte;
};

/** Lane User Control Disable DFE Function Struct */
struct eagle_phy_2_usr_ctrl_disable_dfe_functions_st {
  struct eagle_phy_2_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
...
/** Displays Eye Density Data measured with eagle_phy_2_meas_eye_density_data().
 *
 * The recommended settings are:    \n
 *  eyescan_options.horz_max = 31;  \n
 *  eyescan_options.horz_min = -31; \n
 ...
 * @param buffer_size must provide buffer_size which is returned from eagle_phy_2_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: Stop the microcode [use eagle_phy_2_stop_rx_adaptation()] before using this API
 ...
 */
uint8_t eagle_phy_2_rdbl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t eagle_phy_2_rdwl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t eagle_phy_2_rdbls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t eagle_phy_2_rdwls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t eagle_phy_2_rdbc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t eagle_phy_2_rdwc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t eagle_phy_2_rdbcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t eagle_phy_2_rdwcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t eagle_phy_2_rdw_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t eagle_phy_2_rdb_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t eagle_phy_2_rdws_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t eagle_phy_2_rdbs_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
