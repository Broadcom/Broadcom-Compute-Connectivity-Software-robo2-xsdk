 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: eagle_phy_2_interface.h 1490 2016-08-11 22:26:06Z cvazquez $   *
 *                                                                                 *
 ...
 * (http://ingbu.broadcom.com/hsip/eagle_phy_2/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * eagle_phy_2_interface.h - provides the primary functionality.
 *
 * eagle_phy_2_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * 
 * This license is set out in https://github.com/Broadcom/Broadcom-Compute-Connectivity-Software-robo2-xsdk/master/Legal/LICENSE file.
 *
 * Copyright 2020 Broadcom Inc Corporation all rights reserved
 */

/** @file eagle_phy_2_interface.h
 * Main interface functions provided to IP User
 */

#ifndef EAGLE_PHY_2_API_INTERFACE_H
#define EAGLE_PHY_2_API_INTERFACE_H
...
struct eagle_phy_2_uc_lane_config_field_st {
...
struct eagle_phy_2_uc_core_config_field_st {
...
/** Lane Config Struct */
struct  eagle_phy_2_uc_lane_config_st {
  struct eagle_phy_2_uc_lane_config_field_st field;
  uint16_t word;
};

/** Core Config Struct */
struct  eagle_phy_2_uc_core_config_st {
  struct eagle_phy_2_uc_core_config_field_st field;
  uint16_t word;
  int vco_rate_in_Mhz; /* if >0 then will get converted and replace field.vco_rate when update is called */
};

/** Eyescan Options Struct */
struct eagle_phy_2_eyescan_options_st {
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_get_uc_core_config( const phymod_access_t *pa, struct eagle_phy_2_uc_core_config_st *struct_val);
...
/** Column definition header for eagle_phy_2_display_core_state() API output.
 * To be called before eagle_phy_2_display_core_state_line() API.
 ...
 * Call eagle_phy_2_display_core_state_hdr() API before and eagle_phy_2_display_core_state_legend() after
...
/** Detailed description of each column in eagle_phy_2_display_core_state_line() API output.
 * To be called after eagle_phy_2_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 */
err_code_t eagle_phy_2_uc_active_enable( const phymod_access_t *pa, uint8_t enable);
 ...
 * \n Note: Micro should be loaded only after issuing a eagle_phy_2_uc_reset(1) followed by asserting and de-asserting
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_ucode_mdio_load( const phymod_access_t *pa, uint8_t *ucode_image, uint16_t ucode_len);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_ucode_load_verify( const phymod_access_t *pa, uint8_t *ucode_image, uint16_t ucode_len);
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [eagle_phy_2_ucode_crc_verify()] and verifying the CRC value [eagle_phy_2_start_ucode_crc_calc()].
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [eagle_phy_2_ucode_crc_verify()] and verifying the CRC value [eagle_phy_2_start_ucode_crc_calc()].
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_uc_reset( const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_map_lanes(const phymod_access_t *pa, uint8_t num_lanes, uint8_t const *tx_lane_map, uint8_t const *rx_lane_map);
 ...
 * Note: eagle_phy_2_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 */
err_code_t eagle_phy_2_config_shared_tx_pattern( const phymod_access_t *pa, uint8_t patt_length, const char pattern[]);
 ...
 * Note: User also needs to configure all lanes through eagle_phy_2_lane_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_core_config_for_iddq( const phymod_access_t *pa );

/** Serdes Core Powerdown.
 * Along with eagle_phy_2_core_pwrdn(), all lanes powerdowns should also be issued using
 * eagle_phy_2_lane_pwrdn() to complete a Core Powerdown.
 * @param mode based on enum #srds_core_pwrdn_mode_enum select from ON, CORE, DEEP power down modes
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_core_pwrdn( const phymod_access_t *pa, enum srds_core_pwrdn_mode_enum mode);
 ...
 * If using MDIO interface to access the registers, use this API to implement eagle_phy_2_pmd_mwr_reg().
 ...
 */
err_code_t eagle_phy_2_pmd_mdio_mwr_reg( const phymod_access_t *pa, uint16_t addr, uint16_t mask, uint8_t lsb, uint16_t val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_get_uc_lane_cfg( const phymod_access_t *pa, struct eagle_phy_2_uc_lane_config_st *struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_configure_pll( const phymod_access_t *pa, enum eagle_phy_2_pll_enum pll_cfg);
 ...
 */
err_code_t eagle_phy_2_write_tx_afe( const phymod_access_t *pa, enum srds_tx_afe_settings_enum param, int8_t val);
 ...
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_read_tx_afe( const phymod_access_t *pa, enum srds_tx_afe_settings_enum param, int8_t *val);
 ...
 * @return Error Code generated by invalid tap settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_validate_txfir_cfg( const phymod_access_t *pa, int8_t pre, int8_t main, int8_t post1, int8_t post2, int8_t post3);
 ...
 * It relies on the accuracy of eagle_phy_2_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use eagle_phy_2_read_eye_scan_stripe() function
 ...
 * eagle_phy_2_start_ber_scan_test(), eagle_phy_2_read_ber_scan_data(), eagle_phy_2_display_ber_scan_data().
 *
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 * @param timer_control sets the total test time in units of ~1.31 seconds
 ...
 * \n Note: Call functions eagle_phy_2_display_lane_state_hdr() before and eagle_phy_2_display_lane_state_legend() after
 * to get a formatted lane state display with legend
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_display_lane_state( const phymod_access_t *pa );

/** Column definition header for eagle_phy_2 display state.
 * To be called before eagle_phy_2_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_display_lane_state_hdr( const phymod_access_t *pa );

/** Detailed explanation of each column in eagle_phy_2 display state.
 * To be called after eagle_phy_2_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable eagle_phy_2 support.
...
/** Parameterized diagnostic function which access to all eagle_phy_2 control and status bits
 * This function is required to be implemented by upper level software to enable eagle_phy_2 support.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_pmd_lock_status( const phymod_access_t *pa, uint8_t *pmd_rx_lock);

/** Display CL72 Status of current lane.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_display_cl72_status( const phymod_access_t *pa );
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_tx_disable( const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_rx_restart( const phymod_access_t *pa, uint8_t enable);
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the eagle_phy_2_stop_rx_adaptation() API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_write_rx_afe( const phymod_access_t *pa, enum srds_rx_afe_settings_enum param, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_read_rx_afe( const phymod_access_t *pa, enum srds_rx_afe_settings_enum param, int8_t *val);

/*----------------------------*/
/*  Enable Pattern Generator  */
/*----------------------------*/
/** Enable/Disable Shared TX pattern generator.
 * Note: The patt_length input to the function should be the value sent to the eagle_phy_2_config_shared_tx_pattern() function
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in eagle_phy_2_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_tx_shared_patt_gen_en( const phymod_access_t *pa, uint8_t enable, uint8_t patt_length);
 ...
 * Once the PRBS generator is configured, to enable PRBS use the eagle_phy_2_tx_prbs_en() API.
 * @param prbs_poly_mode PRBS generator mode select (selects required PRBS polynomial)
 * @param prbs_inv PRBS invert enable
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_config_tx_prbs( const phymod_access_t *pa, enum srds_prbs_polynomial_enum prbs_poly_mode, uint8_t prbs_inv);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_get_tx_prbs_config( const phymod_access_t *pa, enum srds_prbs_polynomial_enum *prbs_poly_mode, uint8_t *prbs_inv);

/** PRBS Generator Enable/Disable.
 * @param enable Enable PRBS Generator (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_tx_prbs_en( const phymod_access_t *pa, uint8_t enable);

/** Get PRBS Generator Enable/Disable.
 * @param *enable returns the value of Enable PRBS Generator (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_get_tx_prbs_en( const phymod_access_t *pa, uint8_t *enable);

/** PRBS Generator Single Bit Error Injection.
 * @param enable (1 = error is injected; 0 = no error is injected)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_tx_prbs_err_inject( const phymod_access_t *pa, uint8_t enable);

/**  Configure PRBS Checker.
 * Once the PRBS checker is configured, use the eagle_phy_2_rx_prbs_en() API to enable the checker.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_config_rx_prbs( const phymod_access_t *pa, enum srds_prbs_polynomial_enum prbs_poly_mode, enum srds_prbs_checker_mode_enum prbs_checker_mode, uint8_t prbs_inv);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_get_rx_prbs_config( const phymod_access_t *pa, enum srds_prbs_polynomial_enum *prbs_poly_mode, enum srds_prbs_checker_mode_enum *prbs_checker_mode, uint8_t *prbs_inv);

/** PRBS Checker Enable/Disable.
 * @param enable Enable PRBS Checker (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_rx_prbs_en( const phymod_access_t *pa, uint8_t enable);

/** Get PRBS Checker Enable/Disable.
 * @param *enable returns with the value of Enable PRBS Checker (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_get_rx_prbs_en( const phymod_access_t *pa, uint8_t *enable);

/** PRBS Checker LOCK status (live status).
 * @param *chk_lock Live lock status read by API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_prbs_chk_lock_state( const phymod_access_t *pa, uint8_t *chk_lock);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_prbs_err_count_ll( const phymod_access_t *pa, uint32_t *prbs_err_cnt);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_prbs_err_count_state( const phymod_access_t *pa, uint32_t *prbs_err_cnt, uint8_t *lock_lost);

/*--------------------------------------------------------------*/
/*  IDDQ / Powerdown / Deep Powerdown / Isolate Pins  */
/*--------------------------------------------------------------*/
/** Lane configurations for IDDQ.
 * Note: User needs to configure all lanes through eagle_phy_2_lane_config_for_iddq() and also call eagle_phy_2_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_lane_config_for_iddq( const phymod_access_t *pa );
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_lane_pwrdn( const phymod_access_t *pa, enum srds_core_pwrdn_mode_enum mode);
 ...
 */
err_code_t eagle_phy_2_tx_pi_freq_override( const phymod_access_t *pa, uint8_t enable, int16_t freq_override_val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_loop_timing( const phymod_access_t *pa, uint8_t enable);

/** Enable/Disable Digital Loopback.
 * @param enable Enable Digital Loopback (1 = Enable dig_lpbk; 0 = Disable dig_lpbk)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_dig_lpbk( const phymod_access_t *pa, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t eagle_phy_2_rmt_lpbk( const phymod_access_t *pa, uint8_t enable);
