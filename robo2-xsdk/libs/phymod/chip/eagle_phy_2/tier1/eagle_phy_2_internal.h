 ...
 **********************************************************************************
 *                                                                                *
 *  Revision    :  $Id: eagle_phy_2_internal.h 1457 2016-07-21 21:46:15Z cvazquez $ *
 *                                                                                *
...
/** @file eagle_phy_2_internal.h
 * Internal API functions
 */

#ifndef EAGLE_PHY_2_API_INTERNAL_H
#define EAGLE_PHY_2_API_INTERNAL_H
...
#include "eagle_phy_2_debug_functions.h"
 ...
 * as part of eagle_phy_2_display_core_state_line()
 ...
 */
SDK_STATIC err_code_t _eagle_display_event( const phymod_access_t *pa, uint8_t event_id, uint8_t entry_len, uint8_t prev_cursor, uint8_t curr_cursor, uint8_t post_cursor, uint8_t *supp_info);
 ...
 * @return Usigned 32bit number
 */
/*SDK_STATIC*/ uint32_t _float12_to_uint32( uint8_t byte, uint8_t multi);
 ...
 */
SDK_STATIC uint8_t _uint32_to_float12(  uint32_t input, uint8_t *multi);
#endif

/*-----------------------------*/
/*  Read / Display Core state  */
/*-----------------------------*/
/** Read current eagle_phy_2 core status.
 * @param *istate Current eagle_phy_2 core status read back and populated by the API
...
/*-----------------------------*/
/** Read current eagle_phy_2 lane status.
 * @param *istate Current eagle_phy_2 lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pll_lock Current eagle_phy_2 lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current eagle_phy_2 lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pmd_lock Current eagle_phy_2 lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current eagle_phy_2 lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *sig_det Current eagle_phy_2 lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current eagle_phy_2 lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _eagle_phy_2_get_osr_mode( const phymod_access_t *pa, eagle_phy_2_osr_mode_st *mode);
 ...
 * Along with eagle_phy_2_core_clkgate(), all lanes should also be clock gated using eagle_phy_2_lane_clkgate() to complete a Core Clockgate
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in eagle_phy_2_functions.c.
 *
