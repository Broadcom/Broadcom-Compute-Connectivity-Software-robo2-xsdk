...
err_code_t eagle_phy_2_configure_pll( const phymod_access_t *pa, enum eagle_phy_2_pll_enum pll_cfg) {
    ...
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: eagle_phy_2_configure_pll( pa, ..) called without core_dp_s_rstb=0\n"));
        return (_error(RR_CODE_CORE_DP_NOT_RESET));
    }
#endif
    switch (pll_cfg) {
    /******************/
    /*  Integer Mode  */
    /******************/
    case EAGLE_PHY_2_pll_div_80x_refc125: /* pll_mode<3:0> 1101 VCO 10G      REF 125   MHz */
        ...
        EFUN(wrc_ams_pll_vco_div2      ( 0x0));
        break;
    case EAGLE_PHY_2_pll_div_80x_refc106: /* pll_mode<3:0> 1101 VCO  8.5G    REF 106.25MHz */
        EFUN(wrc_pll_mode              ( 0xD));
        EFUN(wrc_ams_pll_force_kvh_bw  ( 0x1));
    ...
    case EAGLE_PHY_2_pll_div_80x_refc156: /* pll_mode<3:0> 1101 VCO 12.5G    REF 156.25MHz */
        EFUN(wrc_pll_mode             ( 0xD));
        EFUN(wrc_ams_pll_force_kvh_bw ( 0x1));
        EFUN(wrc_ams_pll_2rx_clkbw    ( 0x0));
        EFUN(wrc_ams_pll_kvh_force    ( 0x2));
        EFUN(wrc_ams_pll_vco_div2     ( 0x0));
        break;
    case EAGLE_PHY_2_pll_div_46x:         /* pll_mode<3:0> 0000 VCO  5.75G   REF 125   MHz */
        EFUN(wrc_pll_mode              ( 0x0));
        break;
    case EAGLE_PHY_2_pll_div_50x:         /* pll_mode<3:0> 0101 VCO  6.25G   REF 125   MHz */
        EFUN(wrc_pll_mode              ( 0x5));
        break;
    case EAGLE_PHY_2_pll_div_68x:         /* pll_mode<3:0> 1011 VCO  8.5G    REF 125   MHz */
        EFUN(wrc_pll_mode              ( 0xB));
        break;
    case EAGLE_PHY_2_pll_div_92x:         /* pll_mode<3:0> 1110 VCO 11.5G    REF 125   MHz */
        EFUN(wrc_pll_mode              ( 0xE));
        break;
    case EAGLE_PHY_2_pll_div_100x:        /* pll_mode<3:0> 1111 VCO 12.5G    REF 125   MHz */
        ...
        EFUN(wrc_ams_pll_vco_div2     ( 0x0));
        break;
    case EAGLE_PHY_2_pll_div_40x:         /* pll_mode<3:0> 0010 VCO  6.25G   REF 156.25MHz  */
        ...
        break;
    case EAGLE_PHY_2_pll_div_42x:         /* pll_mode<3:0> 0011 VCO  6.5625G REF 156.25MHz */
        ...
        EFUN(wrc_ams_pll_vco_div2      ( 0x1));
        break;
    case EAGLE_PHY_2_pll_div_52x:         /* pll_mode<3:0> 0110 VCO  8.125G  REF 156.25MHz */
        EFUN(wrc_pll_mode              ( 0x6));
        break;
 /* 5.0G   mode NOT verified by digital team or DVT */
 /* case EAGLE_PHY_2_pll_div_32x:       *//* pll_mode<3:0> 0111 VCO  5.0G    REF 156.25MHz  */
 /*     EFUN(wrc_pll_mode              (   0x7));   */
 /*     break;                                      */
 /* 3.125G mode NOT verified by digital team or DVT */
 /* case EAGLE_PHY_2_pll_div_20x:       *//* pll_mode<3:0> 0100 VCO  3.125G  REF 156.25MHz  */
 ...
 /*     break;                                      */
    case EAGLE_PHY_2_pll_div_60x:
        ...
        break;
    case EAGLE_PHY_2_pll_div_64x_refc161:
    ...
    case EAGLE_PHY_2_pll_div_64x_refc156:
    ...
    case EAGLE_PHY_2_pll_div_72x:
      ...
      /*  Frac-N Mode  */
      /*****************/
    case EAGLE_PHY_2_pll_div_82p5x:  /* DIV  82.5  VCO 10.3125G REF 125   MHz */
        ...
        break;
    case EAGLE_PHY_2_pll_div_87p5x:  /* DIV  87.5  VCO 10.9375G REF 125   MHz */
        ...
        EFUN(wrc_ams_pll_fp3_rh        (   0x1));
        break;
    case EAGLE_PHY_2_pll_div_73p6x:  /* DIV  73.6  VCO 11.5G    REF 156.25MHz */
        ...
        EFUN(wrc_ams_pll_fp3_rh        (   0x1));
        break;
    case EAGLE_PHY_2_pll_div_36p8x:  /* DIV  73.6  VCO 11.5G/2  REF 156.25MHz */
        EFUN(wrc_ams_pll_fracn_ndiv_int(  0x49));
        EFUN(wrc_ams_pll_fracn_div_l   (0x6666));
        EFUN(wrc_ams_pll_fracn_div_h   (   0x2));
        EFUN(wrc_ams_pll_fracn_bypass  (   0x0));
        ...
        EFUN(wrc_ams_pll_fp3_rh        (   0x1));
        break;
    case EAGLE_PHY_2_pll_div_199p04x:/* DIV 199.04 VCO  9.952G  REF  25   MHz */
        ...
        EFUN(wrc_ams_pll_fp3_rh        (   0x1));
        break;
    case EAGLE_PHY_2_pll_div_206p25x: /* DIV 206.25  VCO 10.3125G  REF 50 MHz */
        ...
        break;
    case EAGLE_PHY_2_pll_div_200p00x: /* DIV 200.00  VCO 10G  REF 50 MHz */
        ...
        EFUN(wrc_ams_pll_en_hrz        (   0x1));
        break;
    case EAGLE_PHY_2_pll_div_250p00x: /* DIV 250.00  VCO 12.5G  REF 50 MHz */
    ...
    default:                     /* Invalid pll_cfg value  */
        return _error(RR_CODE_INVALID_PLL_CFG);
        break;
    }  /* switch (pll_cfg) */
    return ERR_CODE_NONE;
}   /* eagle_phy_2_configure_pll */
