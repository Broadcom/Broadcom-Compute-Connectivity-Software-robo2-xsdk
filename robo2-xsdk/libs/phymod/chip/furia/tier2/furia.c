...
int furia_phy_autoneg_ability_set(const phymod_phy_access_t* phy, const phymod_autoneg_ability_t* an_ability)
{
	...
	PHYMOD_IF_ERR_RETURN(
			_furia_get_pll_for_serdes(phymodRefClk156Mhz,SPEED_1G,PLL_MODE_132,&serdes_pll_mode));
            _furia_config_pll_div(&phy->access, serdes_pll_mode);
        value.cl73_adv.an_base_speed = FURIA_CL73_1000BASE_KX;
    } else if (PHYMOD_AN_CAP_10G_KR_GET(an_ability->an_cap)) {
	PHYMOD_IF_ERR_RETURN(
			_furia_get_pll_for_serdes(phymodRefClk156Mhz,SPEED_10G,PLL_MODE_132,&serdes_pll_mode));
        _furia_config_pll_div(&phy->access, serdes_pll_mode);
        value.cl73_adv.an_base_speed = FURIA_CL73_10GBASE_KR;
    } else if (PHYMOD_AN_CAP_40G_KR4_GET(an_ability->an_cap)) {
	PHYMOD_IF_ERR_RETURN(
			_furia_get_pll_for_serdes(phymodRefClk156Mhz,SPEED_40G,PLL_MODE_132,&serdes_pll_mode));
            _furia_config_pll_div(&phy->access, serdes_pll_mode);
	...
	PHYMOD_IF_ERR_RETURN(
			_furia_get_pll_for_serdes(phymodRefClk156Mhz,SPEED_100G,PLL_MODE_165,&serdes_pll_mode));
            _furia_config_pll_div(&phy->access, serdes_pll_mode);
