...
#ifdef VENDOR_BROADCOM
	PHYMOD_VDBG(TEMOD_DBG_CFG, pm_acc,("%-22s: core_id=%0d identified=%0d rv=%0d adr=%0"PRIx32" lmask=%0"PRIx32"\n", 
...
#ifdef VENDOR_BROADCOM
    PHYMOD_VDBG(TEMOD_DBG_TOP, pm_acc,
...
#ifdef VENDOR_BROADCOM
    PHYMOD_VDBG(DBG_SPD, pm_acc, ("%-22s: p=%p adr=%0"PRIx32" tri=%0d multi=%0d\n",
      __func__, (void *)pm_acc, pm_acc->addr, PHYMOD_INTF_MODES_TRIPLE_CORE_GET(config), pmode));
#endif
        return PHYMOD_E_NONE;
    } 
...
#ifdef VENDOR_BROADCOM
    PHYMOD_VDBG(TEMOD_DBG_SPD, pm_acc, ("%-22s: p=%p adr=%0"PRIx32" lmask=%0"PRIx32" spd=%0d(%s) media=%0d\n",
       __func__, (void *)pm_acc, pm_acc->addr, pm_acc->lane_mask, spd_intf, e2s_temod_spd_intfc_type[spd_intf],
...
#ifdef VENDOR_BROADCOM 
#ifdef PHYMOD_DIAG
    PHYMOD_VDBG(TEMOD_DBG_LNK, pm_acc, ("%-22s: p=%p adr=%0"PRIx32" lmask=%0"PRIx32" sp_id=0x%0x rate=%0d phy_intf=%0d(%s) intf_md=%0x\n",
...
#ifdef VENDOR_BROADCOM
    pm_acc = &phy->access;
    PHYMOD_VDBG(TEMOD_DBG_AN, pm_acc, ("%-22s: p=%p adr=%0"PRIx32" lmask=%0"PRIx32" an_cap=%0"PRIx32" bam=%0"PRIx32"\n",
...
#ifdef VENDOR_BROADCOM
    PHYMOD_VDBG(TEMOD_DBG_AN, pm_acc, ("%-22s: p=%p adr=%0"PRIx32" lmask=%0"PRIx32" an_en=%d an_done=%0"PRIx32"\n",
...
#ifdef VENDOR_BROADCOM 
    PHYMOD_VDBG(TEMOD_DBG_LNK, pm_acc, ("%-22s: p=%p adr=%0"PRIx32" lmask=%0"PRIx32" link_status=%0d\n",
