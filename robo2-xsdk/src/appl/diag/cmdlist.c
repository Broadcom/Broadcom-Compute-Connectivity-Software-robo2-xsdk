...
#endif
#endif
#if defined(VENDOR_BROADCOM) && defined(BCM_TOMAHAWK_SUPPORT)
    {"IFPcolormap",      ifp_color_map,      ifp_color_map_usage,
     "Set/Get ifp color map database entry"},
#endif
...
#endif
#if (defined(VENDOR_BROADCOM) && defined(BCM_CALADAN3_SUPPORT))
    {"TracePoint",       cmd_sbx_trace_point,             cmd_sbx_trace_point_usage,       "Trace point for every hardware block"},
#endif
