...
#if 0
/*
 * The official value supported is 0.85V (0x8) but that gave 0.83V - too low
 * The part that we checked with failed on 0.87 (0x1).
 * So the current working low limit is 09V (0)
 */
#define TD2P_MAX_ADJUST 0x8  /* TD2 board valtage starts from 0.85V */
#define TD2P_MAX_ADJUST 0x1  /* TD2 board valtage starts from 0.87V */
#endif
#endif
