...
/*
 * Function:
 *      bcm_robo_custom_auth_params_t_init
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_params_t_init(
    int unit, 
    bcm_custom_auth_params_t *auth_params){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_PARAMS_T_INIT(unit, auth_params));
    return BCM_E_NONE;
}

/*
 * Function:
 *      bcm_robo_custom_auth_port_mode_t_init
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_port_mode_t_init(
    int unit, 
    bcm_custom_auth_port_mode_t *auth_port_mode){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_PORT_MODE_T_INIT(unit, auth_port_mode));
    return BCM_E_NONE;
}

/*
 * Function:
 *      bcm_robo_custom_auth_init
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_init(
    int unit, 
    bcm_custom_auth_params_t *auth_params){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_INIT(unit, auth_params));
    return BCM_E_NONE;
}

/*
 * Function:
 *      bcm_robo_custom_auth_detach
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_detach(
    int unit, 
    bcm_custom_auth_params_t *auth_params){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_DETACH(unit, auth_params));
    return BCM_E_NONE;
}

/*
 * Function:
 *      bcm_robo_custom_auth_mode_get
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_mode_get(
    int unit, 
    bcm_custom_auth_params_t *auth_params){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_MODE_GET(unit, auth_params));
    return BCM_E_NONE;
}

/*
 * Function:
 *      bcm_robo_custom_auth_mode_set
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_mode_set(
    int unit, 
    bcm_custom_auth_params_t *auth_params){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_MODE_SET(unit, auth_params));
    return BCM_E_NONE;
}

/*
 * Function:
 *      bcm_robo_custom_auth_port_get
 * Purpose:
 *      Get Authentication mode of a port.
 * Parameters:
 *      unit   (IN) Unit number.
 *      port_mode - (IN)  Port auth parameter object
 * Returns:
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_port_get(
    int unit, 
    bcm_gport_t portid, 
    bcm_custom_auth_port_mode_t *port_mode){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_PORT_GET(unit, portid, port_mode));
    return BCM_E_NONE;
}

/*
 * Function:
 *      bcm_robo_custom_auth_port_set
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_robo_custom_auth_port_set(
    int unit, 
    bcm_gport_t portid, 
    bcm_custom_auth_port_mode_t *port_mode){

    BCM_IF_ERROR_RETURN(DRV_CUSTOM_AUTH_PORT_SET(unit, portid, port_mode));
    return BCM_E_NONE;
}
