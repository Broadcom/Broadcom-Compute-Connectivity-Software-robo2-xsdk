...
#ifdef VENDOR_BROADCOM
        /*
         * BCMSIM-292 : SIM Jira to track model support. Work around
         * below needed until BCMSIM JIRA is resolved.
         */
#endif
    case soc_feature_uc:
...
#ifdef VENDOR_BROADCOM
        if (soc_property_get(unit, spn_PORTMOD_ENABLE, 0)) {
            return TRUE;
        } else {
            return FALSE;
        }
...
soc_features_bcm56970_a0(int unit, soc_feature_t feature)
{
    ...
    case soc_feature_portmod:
#ifdef VENDOR_BROADCOM
        if (soc_property_get(unit, spn_PORTMOD_ENABLE, 1)) {
            return TRUE;
        } else {
            return FALSE;
        }
...
#ifdef VENDOR_BROADCOM
        return (soc_property_get(unit, "untethered_otp", !SAL_BOOT_SIMULATION));
#else
...
int
soc_features_bcm53158_a0(int unit, soc_feature_t feature)
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((" 53158_a0"));
...
int
soc_features_bcm53158_b0(int unit, soc_feature_t feature)
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((" 53158_b0"));
...
int
soc_features_bcm88652_a0(int unit, soc_feature_t feature)
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((" 88652_a0"));
...
#ifdef VENDOR_CUSTOMER52
int
soc_features_bcm88652_b0(int unit, soc_feature_t feature)
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((" 88652_b0"));
...
#ifdef VENDOR_CUSTOMER52
int
soc_features_bcm88752_a0(int unit, soc_feature_t feature)
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((" 88752_a0"));
...
int
soc_features_bcm88752_b0(int unit, soc_feature_t feature)
{
    COMPILER_REFERENCE(unit);
    SOC_FEATURE_DEBUG_PRINT((" 88752_b0"));
    switch (feature) {
    case soc_feature_controlled_counters:
    case soc_feature_tslam_dma:
    case soc_feature_table_dma:
...
soc_features_bcm56860_a0(int unit, soc_feature_t feature)
{
    ...
    case soc_feature_llfc_force_xon:
#ifdef VENDOR_BROADCOM
                    /* TD2PLUS-1751 Issue observed during parity injection in 
                     * Tabentry_ipipe_l2_user_entry
                     *    don't enable parity for L2_USER_ENTRYm
                     */
#endif
