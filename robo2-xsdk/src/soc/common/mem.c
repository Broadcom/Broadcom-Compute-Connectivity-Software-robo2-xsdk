...
soc_mem_entry_dump_common(int unit, soc_mem_t mem, void *buf, char *prefix, int vertical, char *field_names)
{
    ...
    if ((memp->flags & SOC_MEM_FLAG_MULTIVIEW)
        ...
        if (SOC_MEM_FIELD_VALID(unit, mem, KEY_TYPEf)) {
            ...
            /* L3_ENTRY_ONLY_ECC memory doesn't have (any) ENTRY_TYPEf field */
#endif
...
#ifdef VENDOR_BROADCOM
        /*  For TD2+ only
         *  Confirmed, when read fp_global_mask_tcam, one bit shifted because the 1bit increase of F1 is missing in read logic.
         *  Should be:
         *  Mask[435:219] = {spare_mask[11:0], IPBM_Mask[105:0], F1_mask[49:0],F3_mask[48:0]}
         *  Key[218:2] = {spare[11:0], IPBM[105:0], F1[49:0], F3[48:0]}
         *  but became:
         *  Mask[435:219] = {spare_mask[11:0], F1_mask[49], IPBM_Mask[105:0], F1_mask[48:0],F3_mask[48:0]}
         *  Key[218:2] = {spare[11:0], F1[49], IPBM[105:0], F1[48:0], F3[48:0]}
         *  The bug only affects read value, no impact on write and comparison.
         */
#endif
STATIC void
...
#ifdef VENDOR_BROADCOM
        /*
         * SDK-68670 : WAR for XOR fifo corruption when using
         * MEM_RESET_THIS for VLAN_XLATE and EGR_VLAN_XLATE.
         */
#endif
