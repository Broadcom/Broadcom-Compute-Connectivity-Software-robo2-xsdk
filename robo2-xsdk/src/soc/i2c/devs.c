...
/* JIRA - SDK-62650 Workaround to support I2C Core voltage device
 * on slave addres 0x60.
 * With the latest TH SVK, the ADP4200 device has i2c address of 0x60
 * instead of 0x62 as in TD2.
 */
