...
static soc_phy_table_t _standard_phy_table[] = {
    ...
    {_chk_phy, _phy_id_BCM53158, "BCM53158", &phy_egphy28drv_ge, NULL},
...
static soc_phy_table_t _int_phy_table[] = {
    ...
    {_chk_phy, _phy_id_unknown, "TSCE", &phy_tsce_drv, NULL},
               ...
               soc_phy_info_t *pi, phy_ctrl_t *int_pc)
{
...
#endif /* BCM_TRIUMPH3_SUPPORT */
    {
        if (SOC_IS_ARDON(unit)) {
            ...
            if(SOC_IS_SABER2(unit) || (SOC_IS_AVENGER(unit) && (port != 14))) {
    ...
    } else if (!int_phyd && _chk_gmii(unit, port, &_null_phy_entry, 0xffff, 0xffff, pi)) {
     ...
     */
    if (!int_phyd && _chk_gmii(unit, port, &_null_phy_entry, 0xffff, 0xffff, pi)) {
        int_phyd = _null_phy_entry.driver;
    }
...
#ifdef BCM_ROBO_SUPPORT
    if (SOC_IS_ROBO(unit) && (!SOC_IS_AVENGER(unit)) ) {
...
STATIC phy_id_map_t phy_id_map[] = {
    ...
    { _phy_id_BCM53134,      PHY_BCM53134_OUI,     PHY_BCM53134_MODEL,
      PHY_REV_ALL},
    { _phy_id_BCM53158,      PHY_BCM53158_OUI,     PHY_BCM53158_MODEL,
      PHY_REV_ALL},
