...
typedef struct {
    ...
    int los_usec;                   /* "qtce_los_usec" */
    int an_ctl;                     /* "qtce_diag_an_ctl" */
    int an_link_fail_nocl72_wait_timer;
                                    /* "qtce_diag_an_link_fail_nocl72_wait_timer" */
    int pll_vco_step;               /* "qtce_diag_pll_vco_step" */
    int ability_mask;               /* "tsc_diag_ability_mask" */ 
    int diag_regs;                  /* "qtce_diag_regs" */
    int linkup_bert;                /* "qtce_linkup_bert" */
    int fault_disable;              /* "qtce_fault_disable" */
    int svk_id;                     /* "qtce_svk_id" */
    int diag_verb;                  /* "qtce_diag_verb" */

    /* the following fields are used in tscmod.c, but may not be needed for qtce */
...
#ifdef VENDOR_BROADCOM
    /* SDK-78448 If AN is enable between internal serdes(qtc qsgmii) and 
       system side, even line side is doing forced speed, the autoneg of the 
       system side might take up to 300milli second to link up.
    */
#endif
