...
static int soc_is_robo2 = FALSE;
extern int soc_robo2_chip_find(int unit);
...
soc_robo_chip_reset(int unit){
    ...
    /* Invoke ROBO2 specific API if ROBO2 device is valid */
    if(soc_is_robo2) {
        return (soc_robo2_chip_reset(unit));
    }
...
soc_robo_reset_init(int unit)
{
    /* Invoke ROBO2 specific API if ROBO2 device is valid */
    if(soc_is_robo2) {
        SOC_IF_ERROR_RETURN(soc_robo2_do_init(unit, TRUE));
#ifdef CONFIG_CASCADED_MODE
        SOC_IF_ERROR_RETURN(soc_robo2_do_init(1, TRUE));
...
soc_robo_detach(int unit)
{
    ...
    /* Invoke ROBO2 detach if ROBO2 device is valid */
    if(soc_is_robo2) {
...
_soc_robo_device_created(int unit)
{
    ...
    /* Invoke ROBO2 specific API if ROBO2 device is valid */
    if(soc_is_robo2) {
        return (_soc_robo2_device_created(unit));
    }
...
soc_robo_attach(int unit)
{
    ...
    /* Invoke ROBO2 attach if ROBO2 device is valid */
    rv = soc_robo2_chip_find(unit);
    if(SOC_SUCCESS(rv)) {
        soc_is_robo2 = TRUE;
        SOC_IF_ERROR_RETURN(soc_robo2_attach(unit));
#ifdef CONFIG_CASCADED_MODE
        SOC_IF_ERROR_RETURN(soc_robo2_attach(1));
#endif /* CONFIG_CASCADE_MODE */
        return(SOC_E_NONE);
    }
