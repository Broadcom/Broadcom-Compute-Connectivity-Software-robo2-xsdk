 ...
 *
 * File:	arl_scan.c
 * Purpose:	Robo ARL Scanner Access Routines
 */
...
#include <soc/robo/mcm/arl_scan.h>
...
soc_robo2_arl_update_scan_data_reg(int unit,  soc_robo2_arl_scan_entry_t *entry)
{
    ...
    if (SOC_DRIVER(unit)->type == SOC_CHIP_BCM53158_B0) {
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM_SCAN_DATA_PART2r_ROBO, &regval,
                        VALIDf, &tmpval);
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM_SCAN_DATA_PART0r_ROBO, &regval,
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM_SCAN_DATA_PART1r_ROBO, &regval,
                        FIDf, &tmpval);
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM_SCAN_MASK_PART2r_ROBO, &regval,
                        VALIDf, &tmpval);
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM_SCAN_MASK_PART0r_ROBO, &regval,
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM_SCAN_MASK_PART1r_ROBO, &regval,
                        FIDf, &tmpval);
    ...
    if (SOC_DRIVER(unit)->type == SOC_CHIP_BCM53158_A0) {
        tmpval = entry->valid_key;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM0_SCAN_DATA_PART0r_ROBO, &regval,
                        VALIDf, &tmpval);
        tmpval = entry->dst_key;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM0_SCAN_DATA_PART0r_ROBO, &regval,
                        DSTf, &tmpval);
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM1_SCAN_DATA_PART0r_ROBO, &regval,
                        MAC_LOf, &entry->mac_lo_key);
        /* Program the register */
        ...
        tmpval = entry->fid_key;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM1_SCAN_DATA_PART1r_ROBO, &regval,
                        FIDf, &tmpval);
        tmpval = entry->upd_ctrl_key;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM1_SCAN_DATA_PART1r_ROBO, &regval,
                        UPD_CTRLf, &tmpval);
        ...
        tmpval = entry->valid_mask;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM0_SCAN_MASK_PART0r_ROBO, &regval,
                        VALIDf, &tmpval);
        tmpval = entry->dst_mask;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM0_SCAN_MASK_PART0r_ROBO, &regval,
                        DSTf, &tmpval);
        ...
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM1_SCAN_MASK_PART0r_ROBO, &regval,
                        MAC_LOf, &entry->mac_lo_mask);
        /* Program the register */
        ...
        tmpval = entry->fid_mask;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM1_SCAN_MASK_PART1r_ROBO, &regval,
                        FIDf, &tmpval);
        tmpval = entry->upd_ctrl_mask;
        SOC_REG_FIELD_SET(unit, CB_ITM_ARLFM1_SCAN_MASK_PART1r_ROBO, &regval,
                        UPD_CTRLf, &tmpval);
         ...
         soc_robo2_arl_scanner_op_t cmd, uint32 *index)
{
    ...
    if (cmd != SCANNER_RESUME) {
        ...
        if (rc != SOC_E_NONE) {
            LOG_ERROR(BSL_LS_SOC_CRAL,("soc_robo2_arl_scanner_operation:"
            "Failed updating scanner data registers rc(%d)\n", rc));
            return rc;
        }
    }
    ...
    tmpval = cmd;
    SOC_REG_FIELD_SET(
        unit, CB_ITM_ARL_SCAN_CONFIGr_ROBO, &regval, CMDf, &tmpval);
