...
#define LOW32_MASK  0x00000000ffffffffLL
#define HIGH32_MASK 0xffffffff00000000LL
#define LS32        32
#define RS32        32

#define INDEX_R2      ROBO_INDEX
...
static soc_ctr_ref_t _avenger_unimac_counters[] = {
    {MIB_RX_ALL_OCTETS_HIr_ROBO, MIB_RX_ALL_OCTETS_HIr_CTR},
    {MIB_RX_ALL_OCTETS_LOr_ROBO, MIB_RX_ALL_OCTETS_LOr_CTR},
    {MIB_RX_BRDCASTr_ROBO, MIB_RX_BRDCASTr_CTR},
    {MIB_RXUNICASTPKTSr_ROBO, MIB_RXUNICASTPKTSr_CTR},
    {MIB_RX_MULTr_ROBO, MIB_RX_MULTr_CTR},
    {INVALID_Rr_ROBO, MIB_RX_PAUSr_CTR},
    {MIB_RX_DROPr_ROBO, MIB_RX_DROPr_CTR},
    {MIB_RX_CRC_ALIGNr_ROBO, MIB_RX_CRC_ALIGNr_CTR},
    {MIB_RX_FRAGr_ROBO, MIB_RX_FRAGr_CTR},
    {MIB_RX_JABr_ROBO, MIB_RX_JABr_CTR},
    {MIB_RX_OVRr_ROBO, MIB_RX_OVRr_CTR},
    {MIB_RX_UNDr_ROBO, MIB_RX_UNDr_CTR},
    {MIB_TX_ALL_OCTETS_HIr_ROBO, MIB_TX_ALL_OCTETS_HIr_CTR},
    {MIB_TX_ALL_OCTETS_LOr_ROBO, MIB_TX_ALL_OCTETS_LOr_CTR},
    {MIB_TX_BRDCASTr_ROBO, MIB_TX_BRDCASTr_CTR},
    {MIB_TX_MULTr_ROBO, MIB_TX_MULTr_CTR},
    {MIB_TXUNICASTPKTr_ROBO, MIB_TXUNICASTPKTr_CTR},
    {INVALID_Rr_ROBO, MIB_TX_PAUSr_CTR},
    {MIB_TX_EX_COLr_ROBO, MIB_TX_EX_COLr_CTR},
    {MIB_TX_LATEr_ROBO, MIB_TX_LATEr_CTR},
    {MIB_TX_COLr_ROBO, MIB_TX_COLr_CTR},
    {MIB_TX_64r_ROBO, MIB_TX_64r_CTR},
    {MIB_TX_65_127r_ROBO, MIB_TX_65_127r_CTR},
    {MIB_TX_128_255r_ROBO, MIB_TX_128_255r_CTR},
    {MIB_TX_256_511r_ROBO, MIB_TX_256_511r_CTR},
    {MIB_TX_512_1023r_ROBO, MIB_TX_512_1023r_CTR},
    {MIB_TX_1024_1522r_ROBO, MIB_TX_1024_1522r_CTR},
    {MIB_TX_1523_2047r_ROBO, MIB_TX_1523_2047r_CTR},
    {MIB_TX_2048_4095r_ROBO, MIB_TX_2048_4095r_CTR},
    {MIB_TX_4096_8191r_ROBO, MIB_TX_4096_8191r_CTR},
    {MIB_TX_8192_MAXr_ROBO, MIB_TX_8192_MAXr_CTR},
    {MIB_RX_64r_ROBO, MIB_RX_64r_CTR},
    {MIB_RX_65_127r_ROBO, MIB_RX_65_127r_CTR},
    {MIB_RX_128_255r_ROBO, MIB_RX_128_255r_CTR},
    {MIB_RX_256_511r_ROBO, MIB_RX_256_511r_CTR},
    {MIB_RX_512_1023r_ROBO, MIB_RX_512_1023r_CTR},
    {MIB_RX_1024_1522r_ROBO, MIB_RX_1024_1522r_CTR},
    {MIB_RX_1523_2047r_ROBO, MIB_RX_1523_2047r_CTR},
    {MIB_RX_2048_4095r_ROBO, MIB_RX_2048_4095r_CTR},
    {MIB_RX_4096_8191r_ROBO, MIB_RX_4096_8191r_CTR},
    {MIB_RX_8192_MAXr_ROBO, MIB_RX_8192_MAXr_CTR},
    {MIB_RX_GD_PKTSr_ROBO, MIB_RX_GD_PKTSr_CTR},
    {MIB_TX_GD_PKTSr_ROBO, MIB_TX_GD_PKTSr_CTR},
    {MIB_RX_SYMr_ROBO, MIB_RX_SYMr_CTR},
    {MIB_TX_OVERr_ROBO, MIB_TX_OVERr_CTR},
    {MIB_TX_ALL_PKTSr_ROBO, MIB_TX_ALL_PKTSr_CTR},
    {MIB_RX_ALL_PKTSr_ROBO, MIB_RX_ALL_PKTSr_CTR},
/*  {MIB_TX_FRAGr_ROBO, MIB_TX_FRAGr_CTR},
    {MIB_TX_JABr_ROBO, MIB_TX_JABr_CTR},
*/
};


static soc_ctr_ref_t _avenger_xlmac_counters[] = {
    {RBYTr_ROBO, RBYTr_CTR},
    {TMGVr_ROBO, TMGVr_CTR},
    {RBCAr_ROBO, RBCAr_CTR},
    {RUCAr_ROBO, RUCAr_CTR},
    {RMCAr_ROBO, RMCAr_CTR},
    {TERRr_ROBO, TERRr_CTR},
    {RMGVr_ROBO, RMGVr_CTR},
    {RFCSr_ROBO, RFCSr_CTR},
    {RFRGr_ROBO, RFRGr_CTR},
    {RJBRr_ROBO, RJBRr_CTR},
    {ROVRr_ROBO, ROVRr_CTR},
    {RUNDr_ROBO, RUNDr_CTR},
    {TBYTr_ROBO, TBYTr_CTR},
    {RALNr_ROBO, RALNr_CTR},
    {TBCAr_ROBO, TBCAr_CTR},
    {TMCAr_ROBO, TMCAr_CTR},
    {TUCAr_ROBO, TUCAr_CTR},
    {TFCSr_ROBO, TFCSr_CTR},
    {TXCLr_ROBO, TXCLr_CTR},
    {TLCLr_ROBO, TLCLr_CTR},
    {TNCLr_ROBO, TNCLr_CTR},
    {T64r_ROBO, T64r_CTR},
    {T127r_ROBO, T127r_CTR},
    {T255r_ROBO, T255r_CTR},
    {T511r_ROBO, T511r_CTR},
    {T1023r_ROBO, T1023r_CTR},
    {T1518r_ROBO, T1518r_CTR},
    {T2047r_ROBO, T2047r_CTR},
    {T4095r_ROBO, T4095r_CTR},
    {T9216r_ROBO, T9216r_CTR},
    {T16383r_ROBO, T16383r_CTR},
    {R64r_ROBO, R64r_CTR},
    {R127r_ROBO, R127r_CTR},
    {R255r_ROBO, R255r_CTR},
    {R511r_ROBO, R511r_CTR},
    {R1023r_ROBO, R1023r_CTR},
    {R1518r_ROBO, R1518r_CTR},
    {R2047r_ROBO, R2047r_CTR},
    {R4095r_ROBO, R4095r_CTR},
    {R9216r_ROBO, R9216r_CTR},
    {R16383r_ROBO, R16383r_CTR},
    {RPOKr_ROBO, RPOKr_CTR},
    {TPOKr_ROBO, TPOKr_CTR},
    {RERPKTr_ROBO, RERPKTr_CTR},
    {TOVRr_ROBO, TOVRr_CTR},
    {TPKTr_ROBO, TPKTr_CTR},
    {RPKTr_ROBO, RPKTr_CTR},
/*  {TFRGr_ROBO, TFRGr_CTR},
    {TJBRr_ROBO, TJBRr_CTR},
*/
};
...
void
soc_robo2_counter_illegal(int unit, soc_reg_t ctr_reg)
{
...
static soc_cmap_t counter_maps_avenger[SOC_CTR_NUM_TYPES] = {
    {NULL, 0},                                         /* FE */
    {_avenger_unimac_counters, SOC_MAX_ROBO2_COUNTER_NUM},   /* GE */
    {NULL, 0},                                         /* GFE */
    {NULL, 0},                                         /* HG */
    {_avenger_xlmac_counters, SOC_MAX_ROBO2_COUNTER_NUM},    /* XE */
    {NULL, 0},                                         /* CE */
    {NULL, 0},                                         /* CPU */
    {NULL, 0},                                         /* RX */
    {NULL, 0}                                          /* TX */
 ...
 */
void
soc_robo2_counter_cmap_init(int unit)
{
    uint32_t  port = 0;
...
soc_cmap_t *
soc_robo2_port_cmap_get(int unit, uint32_t port)
{
    return (_port_cmap[unit][port]);
}

int
soc_robo2_port_cmap_set(int unit, uint32_t port, soc_ctr_type_t ctype)
{
...
/*
 * Function:
 *      soc_robo2_counter_collect_sync
 * Purpose:
 ...
 */
static int
soc_robo2_counter_collect_sync(int unit, uint32_t port, soc_reg_t ctr_reg,
                                uint32_t ctr_idx)
{
 ...
 */
static  int
soc_robo2_counter_get(int unit, uint32_t port, soc_reg_t ctr_reg,
...
/*uncomment below code after reg file is properly updated with the counter flag*/
    ...
    if (!SOC_REG_IS_COUNTER(unit, ctr_reg)) {
        soc_robo2_counter_illegal(unit, ctr_reg);
    ...
    if (unit == CBX_AVENGER_PRIMARY) {
        counter_index =(port * SOC_MAX_ROBO2_COUNTER_NUM) +
                        ctr_idx;
    } else {
        counter_index =((port + CBX_MAX_PORT_PER_UNIT) * SOC_MAX_ROBO2_COUNTER_NUM) +
                        ctr_idx;
    }

    if (sync_hw == TRUE) {
        /* Sync the software counter with hardware counter */
        soc_robo2_counter_collect_sync(unit, port,
 ...
 */
static int
soc_robo2_counter_set(int unit, uint32_t port, soc_reg_t ctr_reg,
 ...
 */
int
soc_robo2_counter_set_by_port(int unit, uint32_t port, uint64_t val)
{
    int             i;
...
*/
    ...
    for (i = 0; i < SOC_MAX_ROBO2_COUNTER_NUM; i++) {
        ctr_ref = &port_cmap->cmap_base[i];
        if (ctr_ref->reg != INDEX_R2(INVALID_Rr)) {
            SOC_IF_ERROR_RETURN
                (soc_robo2_counter_set(unit, port, ctr_ref->reg, val,
                                        ctr_ref->index));
        }
    }
    return SOC_E_NONE;
...
#ifdef COUNTER_THREAD
int
soc_robo2_counter_collect(int unit, int discard)
{
    COUNTER_ATOMIC_DEF   soc = SOC_CONTROL(unit);
    int                  counter_index = 0;
    uint32_t             i = 0;
    ...
    PBMP_ITER(soc->counter_pbmp, port) {
        ...
        for (i = 0; i < PORT_CTR_NUM(internal_unit, internal_port); i++) {
            ...
            if (internal_unit == CBX_AVENGER_PRIMARY) {
                counter_index = (internal_port * SOC_MAX_ROBO2_COUNTER_NUM) +
                                ctr_ref->index;
            } else {
                counter_index =((internal_port + CBX_MAX_PORT_PER_UNIT) *
                                 SOC_MAX_ROBO2_COUNTER_NUM) +
                             ctr_ref->index;
            }
            ctr_prev = soc->counter_hw_val[counter_index];
            COMPILER_64_ZERO(ctr_new);
 ...
 */
void
soc_robo2_counter_thread_run_set(int run)
{
 ...
 */
void
soc_robo2_counter_thread(void *args)
{
    ...
    LOG_INFO(BSL_LS_SOC_COUNTER,
             (BSL_META_U(unit,
                         "soc_robo2_counter_thread: unit=%d\n"), unit));
    ...
    if (soc->counter_notify == NULL) {
        ...
        LOG_ERROR(BSL_LS_SOC_COMMON,(BSL_META_U(unit,
                         "soc_robo2_counter_thread: semaphore init failed\n")));
    ...
    while ((interval = soc->counter_interval) != 0) {
         ...
         * immediately when soc_robo2_counter_stop wants it to.
         */

        LOG_VERBOSE(BSL_LS_SOC_COUNTER,
                    (BSL_META_U(unit,"soc_robo2_counter_thread: sleep %d\n"),
                    interval));
/* modify 10 to interval once tested with actual device.with emulator(qt16) use 4*/
        ...
        if ((rv = soc_robo2_counter_collect(unit, 0)) < 0) {
            LOG_ERROR(BSL_LS_SOC_COMMON,(BSL_META_U(unit,
                        "soc_robo2_counter_thread: collect failed. \n")));
        }

        if(SOC_IS_CASCADED(CBX_AVENGER_PRIMARY)){
            if ((rv = soc_robo2_counter_collect(CBX_AVENGER_SECONDARY, 0)) < 0) {
                LOG_ERROR(BSL_LS_SOC_COMMON,(BSL_META_U(unit,
    ...
    if (rv < 0) {
        ...
        LOG_ERROR(BSL_LS_SOC_COMMON,(BSL_META_U(unit,
                    "soc_robo2_counter_thread: Operation failed - exiting\n")));
    }


    LOG_INFO(BSL_LS_SOC_COUNTER,
             (BSL_META_U(unit,
                         "soc_robo2_counter_thread: exiting\n")));
 ...
 */
int
soc_robo2_counter_start(int unit, uint32_t flags, int interval, pbmp_t pbmp)
{
    COUNTER_ATOMIC_DEF soc = SOC_CONTROL(unit);
    sal_sem_t          sem;
    ...
    LOG_INFO(BSL_LS_SOC_COUNTER,
             (BSL_META_U(unit,
                         "soc_robo2_counter_start: unit=%d flags=0x%x "
                         "interval=%d pbmp=%d\n"),
    ...
    if (soc->counter_pid != SAL_THREAD_ERROR) {
        SOC_IF_ERROR_RETURN(soc_robo2_counter_stop(unit));
    }
    /* Configure */
    ...
    SOC_IF_ERROR_RETURN(soc_robo2_counter_collect(unit, 1));

    if(SOC_IS_CASCADED(CBX_AVENGER_PRIMARY)){
        SOC_IF_ERROR_RETURN(soc_robo2_counter_collect(CBX_AVENGER_SECONDARY, 1));
    }
    ...
    if (interval) {
        soc->counter_pid =
            sal_thread_create(soc->counter_name,
                              1024,
                              50,
                              soc_robo2_counter_thread, NULL);

        if (soc->counter_pid == SAL_THREAD_ERROR) {

            LOG_ERROR(BSL_LS_SOC_COMMON,(BSL_META_U(unit,
                        "soc_robo2_counter_start: Thread create failed\n")));
        ...
        LOG_INFO(BSL_LS_SOC_COUNTER,
                 (BSL_META_U(unit,
                             "soc_robo2_counter_start: Complete\n")));
        ...
        LOG_INFO(BSL_LS_SOC_COUNTER,
                 (BSL_META_U(unit,
                             "soc_robo2_counter_start: Inactive\n")));
 ...
 *  is reflected in the results of any soc_robo22_counter_get()-type
 *  routine that is called after the sync.
 */

int
soc_robo2_counter_sync(int unit)
{
    COUNTER_ATOMIC_DEF soc = SOC_CONTROL(unit);
    int                interval;
...
*/
    ...
    if (soc->counter_sync_req) {
        LOG_ERROR(BSL_LS_SOC_COMMON,(BSL_META_U(unit,
                "soc_robo2_counter_sync: counter thread not responding\n")));
 ...
 */
int
soc_robo2_counter_stop(int unit)
{
    COUNTER_ATOMIC_DEF soc = SOC_CONTROL(unit);
    int                rv = SOC_E_NONE;
    ...
    if (soc->counter_pid != SAL_THREAD_ERROR) {
        ...
        if (soc->counter_pid != SAL_THREAD_ERROR) {
            LOG_ERROR(BSL_LS_SOC_COMMON,(BSL_META_U(unit,
                           "soc_robo2_counter_stop: thread will not exit\n")));
            rv = SOC_E_INTERNAL;
        }
    }
    ...
    LOG_INFO(BSL_LS_SOC_COUNTER,
             (BSL_META_U(unit,
                         "soc_robo2_counter_stop: stopped\n")));
    return (rv);
}
...
soc_robo2_counter_attach(int unit)
{
...
#ifdef MANAGED_MODE
    n_bytes = ((SW_COUNT_ARR) * sizeof(uint64));

    if (soc->counter_hw_val == NULL) {
        soc->counter_hw_val = sal_alloc(n_bytes, "ctr hw");
        if (soc->counter_hw_val == NULL) {
            goto error;
        }
    }
    ...
    if (soc->counter_sw_val == NULL) {
        soc->counter_sw_val = sal_alloc(n_bytes, "ctr sw");
        if (soc->counter_sw_val == NULL) {
            goto error;
        }
    }
    ...
    soc_robo2_counter_cmap_init(unit);
 ...
 */
int
soc_robo2_counter_reset(uint32_t unit)
{
    uint32_t    port = 0;
    uint64_t    ctrreset = 0;
    PBMP_ITER(PBMP_ALL(unit), port) {
        ...
        soc_robo2_counter_set_by_port(unit, port, ctrreset);
    }
    return SOC_E_NONE;
}

/*
  *  Function : robo2_counter_thread_set
  *
  *  Purpose :
                       ...
                       int interval, soc_pbmp_t bmp)
{
    ...
    switch (thread_op) {
        case COUNTER_THREAD_START:
            rv = soc_robo2_counter_start(unit, flags, interval, bmp);
            break;
        case COUNTER_THREAD_STOP:
            rv = soc_robo2_counter_stop(unit);
            break;
        case COUNTER_THREAD_SYNC:
            rv = soc_robo2_counter_sync(unit);
            break;
        default:
            rv = SOC_E_PARAM;
    }
 ...
 */
int
robo2_counter_set(int unit,  uint32_t port,
    ...
    if (IS_GE_PORT(unit, port)) {
        switch (counter_type) {
            ...
            case CBX_PORT_STAT_IF_IN_OCTETS:
                ...
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_ALL_OCTETS_LOr), val_lo,
                            MIB_RX_ALL_OCTETS_LOr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_ALL_OCTETS_HIr), val_hi,
            ...
            case CBX_PORT_STAT_IF_IN_UCAST_PKTS:
                ...
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RXUNICASTPKTSr), val,
            ...
            case CBX_PORT_STAT_IF_IN_NON_UCAST_PKTS:
                ...
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            ...
                            MIB_RXUNICASTPKTSr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_ALL_PKTSr), val,
							MIB_RX_ALL_PKTSr_CTR));
                break;

            case CBX_PORT_STAT_IF_IN_DISCARDS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_DROPr), val, MIB_RX_DROPr_CTR));
                break;

            case CBX_PORT_STAT_IF_IN_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_CRC_ALIGNr), val,
                            MIB_RX_CRC_ALIGNr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_FRAGr), val, MIB_RX_FRAGr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_OVRr), val, MIB_RX_OVRr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_UNDr), val, MIB_RX_UNDr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_JABr), val, MIB_RX_JABr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_SYMr), val, MIB_RX_SYMr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_IN_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_BRDCASTr), val, MIB_RX_BRDCASTr_CTR));
                break;

            case CBX_PORT_STAT_IF_IN_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_MULTr), val, MIB_RX_MULTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_OCTETS:
                ...
                val_hi = ((val & HIGH32_MASK) >> RS32);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_ALL_OCTETS_LOr), val_lo,
                            MIB_TX_ALL_OCTETS_LOr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_ALL_OCTETS_HIr), val_hi,
                            MIB_TX_ALL_OCTETS_HIr_CTR));
                break;

            case CBX_PORT_STAT_IF_OUT_UCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TXUNICASTPKTr), val,
            ...
            case CBX_PORT_STAT_IF_OUT_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_EX_COLr), val, MIB_TX_EX_COLr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_LATEr), val, MIB_TX_LATEr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_BRDCASTr), val, MIB_TX_BRDCASTr_CTR));
                break;

            case CBX_PORT_STAT_IF_OUT_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_MULTr), val, MIB_TX_MULTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_64r), val, MIB_RX_64r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_64r), val, MIB_TX_64r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_65_127r), val, MIB_RX_65_127r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_65_127r), val, MIB_TX_65_127r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_128_255r), val, MIB_RX_128_255r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_128_255r), val, MIB_TX_128_255r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_256_511r), val, MIB_RX_256_511r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_256_511r), val, MIB_TX_256_511r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_512_1023r), val,
                            MIB_RX_512_1023r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_512_1023r), val,
                            MIB_TX_512_1023r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_1024_1522r), val,
                            MIB_RX_1024_1522r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_1024_1522r), val,
                            MIB_TX_1024_1522r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_1523_2047r), val,
                            MIB_RX_1523_2047r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_1523_2047r), val,
                            MIB_TX_1523_2047r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_2048_4095r), val,
                            MIB_RX_2048_4095r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_2048_4095r), val,
                            MIB_TX_2048_4095r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_4096_8191r), val,
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_8192_MAXr), val,
                            MIB_RX_8192_MAXr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_8192_MAXr), val,
            ...
            case CBX_PORT_STAT_ETHER_TX_OVERSIZE_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_OVERr), val, MIB_TX_OVERr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_COLLISIONS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_COLr), val, MIB_TX_COLr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_TX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_GD_PKTSr), val, MIB_TX_GD_PKTSr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_RX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_RX_GD_PKTSr), val, MIB_RX_GD_PKTSr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_OUT_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(MIB_TX_4096_8191r), val,
                            MIB_TX_4096_8191r_CTR));
                break;
            ...
            default:
                ...
                LOG_VERBOSE(BSL_LS_SOC_COMMON,
                            (BSL_META_U(unit,
                            "robo2_counter_set:Statistic not supported:%d\n"),
                            counter_type));
        ...
        switch (counter_type) {
            ...
            case CBX_PORT_STAT_IF_IN_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RALNr), val, RALNr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RFCSr), val, RFCSr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RFRGr), val, RFRGr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(ROVRr), val, ROVRr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RUNDr), val, RUNDr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RJBRr), val, RJBRr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RERPKTr), val, RERPKTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_IN_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RBCAr), val, RBCAr_CTR));
                break;

            case CBX_PORT_STAT_IF_IN_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RMCAr), val, RMCAr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_NON_UCAST_PKTS:
                /* All frames minus unicast frames */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TUCAr), val, TUCAr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TPKTr), val, TPKTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TXCLr), val, TXCLr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TLCLr), val, TLCLr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TERRr), val, TERRr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TBCAr), val, TBCAr_CTR));
                break;

            case CBX_PORT_STAT_IF_OUT_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TMCAr), val, TMCAr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R64r), val, R64r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T64r), val, T64r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R127r), val, R127r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T127r), val, T127r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R255r), val, R255r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T255r), val, T255r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R511r), val, R511r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T511r), val, T511r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R1023r), val,    R1023r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T1023r), val,    T1023r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R1518r), val, R1518r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T1518r), val, T1518r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RMGVr), val, RMGVr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TMGVr), val, TMGVr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R2047r), val, R2047r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T2047r), val, T2047r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R4095r), val,    R4095r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T4095r), val,    T4095r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R9216r), val, R9216r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T9216r), val, T9216r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(R16383r), val, R16383r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(T16383r), val, T16383r_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RBYTr), val, RBYTr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TBYTr), val, TBYTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_CRC_ALIGN_ERRORS:
                ...
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RFCSr), val, RFCSr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TFCSr), val, TFCSr_CTR));
                break;


            case CBX_PORT_STAT_ETHER_STATS_TX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(TPOKr), val, TPOKr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_RX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_set(unit, port,
                            INDEX_R2(RPOKr), val, RPOKr_CTR));
                break;
        ...
        LOG_VERBOSE(BSL_LS_SOC_COMMON,
                    (BSL_META_U(unit,
                     "robo2_counter_set: port %d type not supported: \n"), port));
        return SOC_E_NOT_FOUND;
    }
 ...
 *
 */
int robo2_counter_get(int unit, uint32_t port,
...
*/
    ...
    if (IS_GE_PORT(unit, port)) {
        switch (counter_type)
        {
            ...
            case CBX_PORT_STAT_IF_IN_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_ALL_OCTETS_HIr), sync_hw, &count,
                            MIB_RX_ALL_OCTETS_HIr_CTR));
                count = count << LS32;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_ALL_OCTETS_LOr), sync_hw, &count_tmp,
                            MIB_RX_ALL_OCTETS_LOr_CTR));
            ...
            case CBX_PORT_STAT_IF_IN_UCAST_PKTS:
                /* Total non-error frames minus broadcast/multicast frames */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RXUNICASTPKTSr), sync_hw, &count,
                            MIB_RXUNICASTPKTSr_CTR));
                   break;
            ...
            case CBX_PORT_STAT_IF_IN_NON_UCAST_PKTS:
                /* All frames minus unicast frames */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_ALL_PKTSr), sync_hw, &count,
                            MIB_RX_ALL_PKTSr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RXUNICASTPKTSr), sync_hw, &count_tmp,
                            MIB_RXUNICASTPKTSr_CTR));
            ...
            case CBX_PORT_STAT_IF_IN_DISCARDS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_DROPr), sync_hw, &count,
                            MIB_RX_DROPr_CTR));
                break;

            case CBX_PORT_STAT_IF_IN_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_CRC_ALIGNr), sync_hw, &count_tmp,
                            MIB_RX_CRC_ALIGNr_CTR));
                count=count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_FRAGr), sync_hw, &count_tmp,
                            MIB_RX_FRAGr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_OVRr), sync_hw, &count_tmp,
                            MIB_RX_OVRr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_UNDr), sync_hw, &count_tmp,
                            MIB_RX_UNDr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_JABr), sync_hw, &count_tmp,
                            MIB_RX_JABr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_SYMr), sync_hw, &count_tmp,
                            MIB_RX_SYMr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
            ...
            case CBX_PORT_STAT_IF_IN_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_BRDCASTr), sync_hw, &count,
                            MIB_RX_BRDCASTr_CTR));
                break;

            case CBX_PORT_STAT_IF_IN_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_MULTr), sync_hw, &count,
                            MIB_RX_MULTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_ALL_OCTETS_HIr), sync_hw, &count_tmp,
                            MIB_TX_ALL_OCTETS_HIr_CTR));
                count = count_tmp << LS32;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_ALL_OCTETS_LOr), sync_hw, &count_tmp,
                            MIB_TX_ALL_OCTETS_LOr_CTR));
                   COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_UCAST_PKTS:  /* ALL - mcast - bcast */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TXUNICASTPKTr), sync_hw, &count,
                            MIB_TXUNICASTPKTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_NON_UCAST_PKTS:
                /* All frames minus unicast frames */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_ALL_PKTSr), sync_hw, &count,
                            MIB_TX_ALL_PKTSr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TXUNICASTPKTr), sync_hw, &count_tmp,
                            MIB_TXUNICASTPKTr_CTR));
                COMPILER_64_SUB_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_EX_COLr), sync_hw, &count_tmp,
                            MIB_TX_EX_COLr_CTR));
                count=count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_LATEr), sync_hw, &count_tmp,
                            MIB_TX_LATEr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_BRDCASTr), sync_hw, &count,
                            MIB_TX_BRDCASTr_CTR));
                break;

            case CBX_PORT_STAT_IF_OUT_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_MULTr), sync_hw, &count,
                            MIB_TX_MULTr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_MULTr), sync_hw, &count_tmp,
                            MIB_TX_MULTr_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_MULTr), sync_hw, &count_tmp,
                            MIB_RX_MULTr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_BRDCASTr), sync_hw, &count_tmp,
                            MIB_TX_BRDCASTr_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_BRDCASTr), sync_hw, &count_tmp,
                            MIB_RX_BRDCASTr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_UNDERSIZE_PKTS:
                /* Undersize frames-as per RFC, use only count from RX */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_UNDr), sync_hw, &count,
                            MIB_RX_UNDr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_FRAGMENTS:
                /* Fragment frames-as per RFC, use only count from RX */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_FRAGr), sync_hw, &count,
                            MIB_RX_FRAGr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_64r), sync_hw, &count_tmp,
                            MIB_TX_64r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_64r), sync_hw, &count_tmp,
                            MIB_RX_64r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_65_127r), sync_hw, &count_tmp,
                            MIB_TX_65_127r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_65_127r), sync_hw, &count_tmp,
                            MIB_RX_65_127r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_128_255r), sync_hw, &count_tmp,
                            MIB_TX_128_255r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_128_255r), sync_hw, &count_tmp,
                            MIB_RX_128_255r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_256_511r), sync_hw, &count_tmp,
                            MIB_TX_256_511r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_256_511r), sync_hw, &count_tmp,
                            MIB_RX_256_511r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_512_1023r), sync_hw, &count_tmp,
                            MIB_TX_512_1023r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_512_1023r), sync_hw, &count_tmp,
                            MIB_RX_512_1023r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_1024_1522r), sync_hw, &count_tmp,
                            MIB_TX_1024_1522r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_1024_1522r), sync_hw, &count_tmp,
                            MIB_RX_1024_1522r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_1523_2047r), sync_hw, &count_tmp,
                            MIB_TX_1523_2047r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_1523_2047r), sync_hw, &count_tmp,
                            MIB_RX_1523_2047r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_2048_4095r), sync_hw, &count_tmp,
                            MIB_TX_2048_4095r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_2048_4095r), sync_hw, &count_tmp,
                            MIB_RX_2048_4095r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_4096_8191r), sync_hw, &count_tmp,
                            MIB_RX_4096_8191r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_4096_8191r), sync_hw, &count_tmp,
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_8192_MAXr), sync_hw, &count_tmp,
                            MIB_TX_8192_MAXr_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_8192_MAXr), sync_hw, &count_tmp,
                            MIB_RX_8192_MAXr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_OVERSIZE_PKTS:
                /* Oversize frames-as per RFC, use only count from RX */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_OVRr), sync_hw, &count,
                            MIB_RX_OVRr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_TX_OVERSIZE_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_OVERr), sync_hw, &count,
                            MIB_TX_OVERr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_JABBERS:
                /* Jabber frames-as per RFC, use only count from RX */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_JABr), sync_hw, &count,
                            MIB_RX_JABr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_ALL_OCTETS_HIr), sync_hw, &count,
                            MIB_TX_ALL_OCTETS_HIr_CTR));
                count = count << LS32;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_ALL_OCTETS_LOr), sync_hw, &count_tmp,
                ...
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_ALL_OCTETS_HIr), sync_hw, &count_tmp,
                            MIB_RX_ALL_OCTETS_HIr_CTR));
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_ALL_PKTSr), sync_hw, &count_tmp,
                            MIB_TX_ALL_PKTSr_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_ALL_PKTSr), sync_hw, &count_tmp,
                            MIB_RX_ALL_PKTSr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_COLLISIONS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_COLr), sync_hw, &count,
                            MIB_TX_COLr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_CRC_ALIGN_ERRORS:
                /* CRC errors + alignment errors */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_CRC_ALIGNr), sync_hw, &count,
                            MIB_RX_CRC_ALIGNr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_TX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_GD_PKTSr), sync_hw, &count,
                            MIB_TX_GD_PKTSr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_RX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_GD_PKTSr), sync_hw, &count,
                            MIB_RX_GD_PKTSr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_IN_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_64r), sync_hw, &count,
                            MIB_RX_64r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_65_127r), sync_hw, &count,
                            MIB_RX_65_127r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_128_255r), sync_hw, &count,
                            MIB_RX_128_255r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_256_511r), sync_hw, &count,
                            MIB_RX_256_511r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_512_1023r), sync_hw, &count,
                            MIB_RX_512_1023r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_1024_1522r), sync_hw, &count,
                            MIB_RX_1024_1522r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_1523_2047r), sync_hw, &count,
                            MIB_RX_1523_2047r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_2048_4095r), sync_hw, &count,
                            MIB_RX_2048_4095r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_4096_8191r), sync_hw, &count,
                            MIB_RX_4096_8191r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_RX_8192_MAXr), sync_hw, &count,
                            MIB_RX_8192_MAXr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_64r), sync_hw, &count,
                            MIB_TX_64r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_65_127r), sync_hw, &count,
                            MIB_TX_65_127r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_128_255r), sync_hw, &count,
                            MIB_TX_128_255r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_256_511r), sync_hw, &count,
                            MIB_TX_256_511r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_512_1023r), sync_hw, &count,
                            MIB_TX_512_1023r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_1024_1522r), sync_hw, &count,
                            MIB_TX_1024_1522r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_1523_2047r), sync_hw, &count,
                            MIB_TX_1523_2047r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_2048_4095r), sync_hw, &count,
                            MIB_TX_2048_4095r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_4096_8191r), sync_hw, &count,
                            MIB_TX_4096_8191r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(MIB_TX_8192_MAXr), sync_hw, &count,
                            MIB_TX_8192_MAXr_CTR));
                break;
            ...
            default:
                LOG_VERBOSE(BSL_LS_SOC_COMMON,
                            (BSL_META_U(unit,
                            "robo2_counter_get: Statistic not supported: %d\n"),
                            counter_type));
                return SOC_E_PARAM;
        }
    } else if (IS_XL_PORT(unit, port)) {
        switch (counter_type)
        {
            ...
            case CBX_PORT_STAT_IF_IN_NON_UCAST_PKTS:
                ...
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RPKTr), sync_hw, &count,
                            RPKTr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RUCAr), sync_hw, &count_tmp,
                            RUCAr_CTR));
                COMPILER_64_SUB_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_IF_IN_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RFCSr), sync_hw, &count_tmp,
                            RFCSr_CTR));
                count=count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RALNr), sync_hw, &count_tmp,
                            RALNr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RFRGr), sync_hw, &count_tmp,
                            RFRGr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(ROVRr), sync_hw, &count_tmp,
                            ROVRr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RUNDr), sync_hw, &count_tmp,
                            RUNDr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RJBRr), sync_hw, &count_tmp,
                            RJBRr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RERPKTr), sync_hw, &count_tmp,
                            RERPKTr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
            ...
            case CBX_PORT_STAT_IF_IN_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RBCAr), sync_hw, &count,
                            RBCAr_CTR));
                break;

            case CBX_PORT_STAT_IF_IN_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RMCAr), sync_hw, &count,
                            RMCAr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TBYTr), sync_hw, &count,
                            TBYTr_CTR));
                break;

            case CBX_PORT_STAT_IF_OUT_UCAST_PKTS:  /* Unicast frames */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TUCAr), sync_hw, &count,
                            TUCAr_CTR));
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_NON_UCAST_PKTS:
                /* ALL frames Minus unicast frames */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TPKTr), sync_hw, &count,
                            TPKTr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TUCAr), sync_hw, &count_tmp,
                            TUCAr_CTR));
                COMPILER_64_SUB_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TXCLr), sync_hw, &count_tmp,
                            TXCLr_CTR));
                count=count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TLCLr), sync_hw, &count_tmp,
                            TLCLr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TERRr), sync_hw, &count_tmp,
                            TERRr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_IF_OUT_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TBCAr), sync_hw, &count,
                            TBCAr_CTR));
                break;

            case CBX_PORT_STAT_IF_OUT_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TMCAr), sync_hw, &count,
                            TMCAr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_MULTICAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TMCAr), sync_hw, &count_tmp,
                            TMCAr_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RMCAr), sync_hw, &count_tmp,
                            RMCAr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_BROADCAST_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TBCAr), sync_hw, &count_tmp,
                            TBCAr_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RBCAr), sync_hw, &count_tmp,
                            RBCAr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_FRAGMENTS:
                /* Fragment frames-as per RFC, use only count from RX */
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RFRGr), sync_hw, &count,
                            RFRGr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T64r), sync_hw, &count_tmp,
                            T64r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R64r), sync_hw, &count_tmp,
                            R64r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T127r), sync_hw, &count_tmp,
                            T127r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R127r), sync_hw, &count_tmp,
                            R127r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T255r), sync_hw, &count_tmp,
                            T255r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R255r), sync_hw, &count_tmp,
                            R255r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T511r), sync_hw, &count_tmp,
                            T511r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R511r), sync_hw, &count_tmp,
                            R511r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T1023r), sync_hw, &count_tmp,
                            T1023r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R1023r), sync_hw, &count_tmp,
                            R1023r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T1518r), sync_hw, &count_tmp,
                            T1518r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R1518r), sync_hw, &count_tmp,
                            R1518r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RMGVr), sync_hw, &count_tmp,
                            RMGVr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TMGVr), sync_hw, &count_tmp,
                            TMGVr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T2047r), sync_hw, &count_tmp,
                            T2047r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R2047r), sync_hw, &count_tmp,
                            R2047r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T4095r), sync_hw, &count_tmp,
                            T4095r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R4095r), sync_hw, &count_tmp,
                            R4095r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T9216r), sync_hw, &count_tmp,
                            T9216r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R9216r), sync_hw, &count_tmp,
                            R9216r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T16383r), sync_hw, &count_tmp,
                            T16383r_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R16383r), sync_hw, &count_tmp,
                            R16383r_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            ...
                            TBYTr_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RBYTr), sync_hw, &count_tmp,
                            RBYTr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_PKTS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TPKTr), sync_hw, &count_tmp,
                            TPKTr_CTR));
                count = count_tmp;
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RPKTr), sync_hw, &count_tmp,
                            RPKTr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_CRC_ALIGN_ERRORS:
                ...
                COMPILER_64_ADD_64(count, count_tmp);
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TFCSr), sync_hw, &count_tmp,
                            TFCSr_CTR));
                COMPILER_64_ADD_64(count, count_tmp);
                break;
            ...
            case CBX_PORT_STAT_ETHER_STATS_TX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TPOKr), sync_hw, &count,
                            TPOKr_CTR));
                break;

            case CBX_PORT_STAT_ETHER_STATS_RX_NO_ERRORS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RPOKr), sync_hw, &count,
                            RPOKr_CTR));
                break;
            ...
            case CBX_PORT_STAT_ETHER_IN_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R64r), sync_hw, &count,
                            R64r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R127r), sync_hw, &count,
                            R127r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R255r), sync_hw, &count,
                            R255r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R511r), sync_hw, &count,
                            R511r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R1023r), sync_hw, &count,
                            R1023r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R1518r), sync_hw, &count,
                            R1518r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(RMGVr), sync_hw, &count_tmp,
                            RMGVr_CTR));
            ...
            case CBX_PORT_STAT_ETHER_IN_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R2047r), sync_hw, &count,
                            R2047r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R4095r), sync_hw, &count,
                            R4095r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R9216r), sync_hw, &count,
                            R9216r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_IN_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(R16383r), sync_hw, &count,
                            R16383r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_64_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T64r), sync_hw, &count,
                            T64r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_65_TO_127_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T127r), sync_hw, &count,
                            T127r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_128_TO_255_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T255r), sync_hw, &count,
                            T255r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_256_TO_511_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T511r), sync_hw, &count,
                            T511r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_512_TO_1023_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T1023r), sync_hw, &count,
                            T1023r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_1024_TO_1522_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T1518r), sync_hw, &count,
                            T1518r_CTR));
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(TMGVr), sync_hw, &count_tmp,
                            TMGVr_CTR));
            ...
            case CBX_PORT_STAT_ETHER_OUT_PKTS_1523_TO_2047_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T2047r), sync_hw, &count,
                            T2047r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_2048_TO_4095_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T4095r), sync_hw, &count,
                            T4095r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_4096_TO_8191_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T9216r), sync_hw, &count,
                            T9216r_CTR));
                break;

            case CBX_PORT_STAT_ETHER_OUT_PKTS_8192_TO_MAX_OCTETS:
                SOC_IF_ERROR_RETURN(soc_robo2_counter_get(unit, port,
                            INDEX_R2(T16383r), sync_hw, &count,
                            T16383r_CTR));
                break;
        ...
        LOG_VERBOSE(BSL_LS_SOC_COMMON,
                    (BSL_META_U(unit,
                     "robo2_counter_get: port %d type not supported: \n"), port));
        return SOC_E_NOT_FOUND;
    }
    *val = count;
     return SOC_E_NONE;
...
int soc_port_stat_clear(uint32_t portid)
{
    ...
    for (type = 0; type < PORT_STAT_MAX ; type++) {
        rv = robo2_counter_set(0, portid, type, value);
...
int soc_port_stat_dump(uint32_t portid)
{
    ...
    cbx_port_stat_counter_t type = 0;
    for (type = 0; type < PORT_STAT_MAX ; type++) {
        rv = robo2_counter_get(unit,portid,type,sync_hw,&value);
        if((rv == SOC_E_PORT) || (rv == SOC_E_NOT_FOUND))
            return rv;
        if(rv == SOC_E_UNAVAIL)
            continue;
        if(value != 0)
            sal_printf("\nPort:%d ctype:%s ctr_val:%lu",portid,port_stat[type],value);
    }
    return SOC_E_NONE;
}
#endif
