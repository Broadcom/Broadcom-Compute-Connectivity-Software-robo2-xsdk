...
static struct pci_device_id _id_table[] = {
    ...
    { BROADCOM_VENDOR_ID, BCM8371_DEVICE_ID,  PCI_ANY_ID, PCI_ANY_ID },
#endif    
#if defined(VENDOR_BROADCOM) && defined(SHADOW_SVK)
    { BROADCOM_VENDOR_ID, BCM8372_DEVICE_ID,  PCI_ANY_ID, PCI_ANY_ID },
#endif
...
#ifdef VENDOR_BROADCOM
    { BROADCOM_VENDOR_ID, BCM5634x_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
#endif
    ...
    { BROADCOM_VENDOR_ID, BCM56073_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    { BROADCOM_VENDOR_ID, BCM53586_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
    ...
    { BROADCOM_VENDOR_ID, BCM88652_DEVICE_ID, PCI_ANY_ID, PCI_ANY_ID },
#endif
#endif
...
static struct bde_spi_device_id _spi_id_table[] = {
    ...
    { BCM53158_PHYID_HIGH, BCM53158_PHYID_LOW , 0, 0x110240, DEFAULT_FREQ},
    { 0, 0, 0, 0, 0 },
};
#endif
...
#if defined(VENDOR_BROADCOM) && defined(SHADOW_SVK)
    addr = (uint8_t *)(ctrl->bde_dev.base_address) + 0x174;
    writel(0x0, (uint32 *)addr);
    addr = (uint8_t *)ctrl->bde_dev.base_address + DEV_REG_DEVID;
#else 
